...
def shader_cobblestone(nw: NodeWrangler):
    ...
    colorramp_1.color_ramp.elements[0].color = random_color_neighbour((0.0143, 0.0131, 0.0137, 1.0), 0.2, 0.1, 0.1)
    colorramp_1.color_ramp.elements[1].position = 1.0
    colorramp_1.color_ramp.elements[1].color = random_color_neighbour((0.0471, 0.0679, 0.0685, 1.0), 0.2, 0.1, 0.1)
