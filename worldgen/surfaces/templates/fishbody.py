...
def nodegroup_scales(nw: NodeWrangler):
    ...
    mix = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': 1.0, 'Color1': combine_xyz_2, 'Color2': group_input_1.outputs["Scale"]},
        attrs={'blend_type': 'MULTIPLY'})
    
    reroute = nw.new_node(Nodes.Reroute,
        input_kwargs={'Input': mix})
    
    reroute_1 = nw.new_node(Nodes.Reroute,
        input_kwargs={'Input': reroute})
    
    separate_xyz_5 = nw.new_node(Nodes.SeparateXYZ,
    ...
    less_than = nw.new_node(Nodes.Math,
        input_kwargs={0: round, 1: separate_xyz.outputs["Y"]},
    ...
    combine_xyz = nw.new_node(Nodes.CombineXYZ,
        input_kwargs={'X': add_3, 'Y': round})
    
    round_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: separate_xyz.outputs["X"]},
        attrs={'operation': 'ROUND'})
    
    floor_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: separate_xyz.outputs["Y"]},
        attrs={'operation': 'FLOOR'})
    
    add_4 = nw.new_node(Nodes.Math,
        input_kwargs={0: floor_1})
    
    combine_xyz_1 = nw.new_node(Nodes.CombineXYZ,
        input_kwargs={'X': round_1, 'Y': add_4})
    
    mix_2 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': less_than, 'Color1': combine_xyz, 'Color2': combine_xyz_1})
    
    separate_xyz_6 = nw.new_node(Nodes.SeparateXYZ,
        input_kwargs={'Vector': mix_2})
    
    subtract_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: separate_xyz_5.outputs["X"], 1: separate_xyz_6.outputs["X"]},
        attrs={'operation': 'SUBTRACT'})
    
    power = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_1, 1: 2.0},
        attrs={'operation': 'POWER'})
    
    subtract_2 = nw.new_node(Nodes.Math,
        input_kwargs={0: separate_xyz_5.outputs["Y"], 1: separate_xyz_6.outputs["Y"]},
        attrs={'operation': 'SUBTRACT'})
    
    power_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_2, 1: 2.0},
        attrs={'operation': 'POWER'})
    ...
    add_6 = nw.new_node(Nodes.Math,
        input_kwargs={0: sqrt, 1: 0.01})
    
    less_than_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: add_6},
        attrs={'operation': 'LESS_THAN'})
    
    mix_1 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': less_than, 'Color1': combine_xyz_1, 'Color2': combine_xyz})
    
    mix_3 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': 1.0, 'Color1': reroute_1, 'Color2': mix_1},
        attrs={'blend_type': 'SUBTRACT'})
    
    mix_4 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': 1.0, 'Color1': reroute_1, 'Color2': mix_2},
        attrs={'blend_type': 'SUBTRACT'})
    
    mix_5 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': less_than_1, 'Color1': mix_3, 'Color2': mix_4})
    
    combine_rgb = nw.new_node(Nodes.Vector)
    combine_rgb.outputs[0].default_value = (1.0, -1.0, 1.0)
    
    mix_8 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': 1.0, 'Color1': mix_5, 'Color2': combine_rgb},
        attrs={'blend_type': 'MULTIPLY'})
    
    mix_9 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': 1.0, 'Color1': mix_8, 'Color2': (0.0, 0.5, 0.0, 0.0)},
        attrs={'blend_type': 'ADD'})
    
    separate_xyz_1 = nw.new_node(Nodes.SeparateXYZ,
        input_kwargs={'Vector': mix_9})
    
    mix_6 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': less_than_1, 'Color1': mix_1, 'Color2': mix_2})
    
    noise_texture = nw.new_node(Nodes.NoiseTexture,
        input_kwargs={'Vector': mix_6, 'W': 0.8, 'Scale': 33.0},
        attrs={'noise_dimensions': '4D'})
    
    colorramp_1 = nw.new_node(Nodes.ColorRamp,
        input_kwargs={'Fac': noise_texture.outputs["Fac"]})
    colorramp_1.color_ramp.elements[0].position = 0.2591
    ...
    subtract_3 = nw.new_node(Nodes.Math,
        input_kwargs={0: colorramp_1.outputs["Color"]},
        attrs={'operation': 'SUBTRACT'})
    
    sine_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_3},
        attrs={'operation': 'SINE'})
    
    multiply_9 = nw.new_node(Nodes.Math,
        input_kwargs={0: separate_xyz_1.outputs["X"], 1: sine_1},
        attrs={'operation': 'MULTIPLY'})
    
    cosine_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_3},
        attrs={'operation': 'COSINE'})
    
    multiply_10 = nw.new_node(Nodes.Math,
        input_kwargs={0: separate_xyz_1.outputs["Y"], 1: cosine_1},
        attrs={'operation': 'MULTIPLY'})
    ...
    power_2 = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_4, 1: 2.0},
        attrs={'operation': 'POWER'})
    ...
    power_3 = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_5, 1: 2.0},
        attrs={'operation': 'POWER'})
    
    add_8 = nw.new_node(Nodes.Math,
        input_kwargs={0: power_2, 1: power_3})
    ...
    add_9 = nw.new_node(Nodes.Math,
        input_kwargs={0: sqrt_1, 1: 0.01})
    
    mix_7 = nw.new_node(Nodes.MixRGB,
        input_kwargs={'Fac': less_than_1, 'Color1': add_9, 'Color2': add_6})
    
    multiply_11 = nw.new_node(Nodes.Math,
        input_kwargs={0: mix_7, 1: 2.0},
        attrs={'operation': 'MULTIPLY'})
    
    colorramp = nw.new_node(Nodes.ColorRamp,
        input_kwargs={'Fac': multiply_11})
    colorramp.color_ramp.elements[0].position = 0.9356
    colorramp.color_ramp.elements[0].color = (0.0, 0.0, 0.0, 1.0)
    colorramp.color_ramp.elements[1].position = 1.0
    colorramp.color_ramp.elements[1].color = (1.0, 1.0, 1.0, 1.0)
    
    rgb_curves = nw.new_node(Nodes.RGBCurve,
        input_kwargs={'Color': colorramp.outputs["Color"]})
    node_utils.assign_curve(rgb_curves.mapping.curves[0], [(0.0, 0.0), (1.0, 1.0)])
    node_utils.assign_curve(rgb_curves.mapping.curves[1], [(0.0, 0.0), (1.0, 1.0)])
    node_utils.assign_curve(rgb_curves.mapping.curves[2], [(0.0, 0.0), (1.0, 1.0)])
    node_utils.assign_curve(rgb_curves.mapping.curves[3], [(0.0, 0.0), (0.5046, 0.4844), (1.0, 1.0)])
    
    multiply_12 = nw.new_node(Nodes.Math,
        input_kwargs={0: rgb_curves},
        attrs={'operation': 'MULTIPLY'})
    
    subtract_6 = nw.new_node(Nodes.Math,
        input_kwargs={0: add_7, 1: multiply_12},
        attrs={'operation': 'SUBTRACT'})
    
    subtract_7 = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_6, 1: 0.0},
        attrs={'operation': 'SUBTRACT'})
    
    normal = nw.new_node(Nodes.InputNormal)
    
    multiply_13 = nw.new_node(Nodes.VectorMath,
        input_kwargs={0: subtract_7, 1: normal},
        attrs={'operation': 'MULTIPLY'})
    ...
    multiply_14 = nw.new_node(Nodes.VectorMath,
        input_kwargs={0: multiply_13.outputs["Vector"], 1: group_input_3.outputs["Offset"]},
        attrs={'operation': 'MULTIPLY'})
    
    set_position = nw.new_node(Nodes.SetPosition,
        input_kwargs={'Geometry': group_input.outputs["Mesh"], 'Offset': multiply_14.outputs["Vector"]})
    
    capture_attribute_2 = nw.new_node(Nodes.CaptureAttribute,
        input_kwargs={'Geometry': set_position, 1: multiply_11},
        attrs={'data_type': 'FLOAT_VECTOR'})
    
    capture_attribute_1 = nw.new_node(Nodes.CaptureAttribute,
        input_kwargs={'Geometry': capture_attribute_2.outputs["Geometry"], 1: mix_6},
        attrs={'data_type': 'FLOAT_VECTOR'})
    
    capture_attribute = nw.new_node(Nodes.CaptureAttribute,
        input_kwargs={'Geometry': capture_attribute_1.outputs["Geometry"], 1: mix_9},
        attrs={'data_type': 'FLOAT_VECTOR'})
    
    capture_attribute_3 = nw.new_node(Nodes.CaptureAttribute,
        input_kwargs={'Geometry': capture_attribute.outputs["Geometry"], 1: subtract_6},
        attrs={'data_type': 'FLOAT_VECTOR'})
    
    capture_attribute_4 = nw.new_node(Nodes.CaptureAttribute,
        input_kwargs={'Geometry': capture_attribute_3.outputs["Geometry"], 1: multiply_12},
        attrs={'data_type': 'FLOAT_VECTOR'})
    ...
    group_output = nw.new_node(Nodes.GroupOutput,
        input_kwargs={'Geometry': capture_attribute_4.outputs["Geometry"], 
                ...
                'attr2': combine_xyz_3, 
                'attr3': capture_attribute_2.outputs["Attribute"], 
                'attr4': capture_attribute_3.outputs["Attribute"], 
...
def geometry_fish_body(nw: NodeWrangler, rand=True, **input_kwargs):
    ...
    group_output = nw.new_node(Nodes.GroupOutput,
        ...
        'attr1': scales.outputs["attr1"], 
        'attr2': scales.outputs['attr2'],
        'attr3': scales.outputs['attr3'], 
        'attr4': scales.outputs['attr4'], 
