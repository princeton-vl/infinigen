...
def shader(nw, color=None):
    ...
    if color is None:
        col_1 = random_color_neighbour((0.2619, 0.0565, 0.0349, 1.0), 0.1, 0.1, 0.1)
        col_2 = random_color_neighbour((0.7991, 0.2247, 0.1345, 1.0), 0.1, 0.1, 0.1)
    else:
        col_1 = rg(color)
        col_2 = rg(color)
    ...
    colorramp.color_ramp.elements[1].color = (0.2958, 0.2958, 0.2958, 1.0)
