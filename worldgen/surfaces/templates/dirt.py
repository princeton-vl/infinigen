...
def geo_dirt(nw, selection=None, random_seed=0, geometry=True):
    ...
    with FixedSeed(random_seed):
        ...
        colorramp.color_ramp.elements[1].position = 0.709
        colorramp.color_ramp.elements[1].color = (0.1814, 0.0747, 0.0499, 1.0)
        colorramp.color_ramp.elements[2].position = 1.0
        colorramp.color_ramp.elements[2].color = (0.1864, 0.03, 0.0191, 1.0)
...
if __name__ == "__main__":
    ...
    for i in range(10):
        bpy.ops.wm.open_mainfile(filepath='landscape_surface_dev_dirt.blend')
