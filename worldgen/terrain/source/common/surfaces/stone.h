...
geo_stone(float3_nonbuiltin position, float3_nonbuiltin normal,
    ...
    float scal_crack_FROM_geo_stone = float_vars[24];
    float scale0_FROM_geo_stone = float_vars[25];
    float scale1_FROM_geo_stone = float_vars[26];
    float scale2_FROM_geo_stone = float_vars[27];
    float size_bumps_lf_FROM_geo_stone = float_vars[28];
    float zscale0_FROM_geo_stone = float_vars[29];
    float zscale1_FROM_geo_stone = float_vars[30];
    float zscale2_FROM_geo_stone = float_vars[31];
    ...
    scal_crack__Value = scal_crack_FROM_geo_stone;
