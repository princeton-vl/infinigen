...
// refer to worldgen/surfaces/templates/dirt.py which has the copyright and
// authors
DEVICE_FUNC void
geo_dirt(float3_nonbuiltin position, float3_nonbuiltin normal,
    ...
    float4_nonbuiltin color_ramp_1_VAR_FROM_geo_dirt_color0 =
        float4_nonbuiltin_vars[0];
    float4_nonbuiltin color_ramp_1_VAR_FROM_geo_dirt_color1 =
        float4_nonbuiltin_vars[1];
    float color_ramp_1_VAR_FROM_geo_dirt_pos0 = float_vars[4];
    float color_ramp_1_VAR_FROM_geo_dirt_pos1 = float_vars[5];
    float4_nonbuiltin color_ramp_2_VAR_FROM_geo_dirt_color0 =
        float4_nonbuiltin_vars[2];
    float4_nonbuiltin color_ramp_2_VAR_FROM_geo_dirt_color1 =
        float4_nonbuiltin_vars[3];
    float color_ramp_2_VAR_FROM_geo_dirt_pos0 = float_vars[6];
    float color_ramp_2_VAR_FROM_geo_dirt_pos1 = float_vars[7];
    float detail0_FROM_geo_dirt = float_vars[8];
    float detail1_FROM_geo_dirt = float_vars[9];
    float detail2_FROM_geo_dirt = float_vars[10];
    float noise_texture_1_w_FROM_geo_dirt = float_vars[11];
    float noise_texture_2_w_FROM_geo_dirt = float_vars[12];
    float noise_texture_3_w_FROM_geo_dirt = float_vars[13];
    float noise_texture_4_w_FROM_geo_dirt = float_vars[14];
    ...
    float roughness0_FROM_geo_dirt = float_vars[15];
    float roughness1_FROM_geo_dirt = float_vars[16];
    float roughness2_FROM_geo_dirt = float_vars[17];
    float scal_crack_FROM_geo_dirt = float_vars[18];
    float scale0_FROM_geo_dirt = float_vars[19];
    float scale1_FROM_geo_dirt = float_vars[20];
    float scale2_FROM_geo_dirt = float_vars[21];
    float zscale0_FROM_geo_dirt = float_vars[22];
    float zscale1_FROM_geo_dirt = float_vars[23];
    float zscale2_FROM_geo_dirt = float_vars[24];
    ...
    float4_nonbuiltin color_ramp_2_VAR__Color;

    float color_ramp_2_VAR_positions[2]{color_ramp_2_VAR_FROM_geo_dirt_pos0,
                                        color_ramp_2_VAR_FROM_geo_dirt_pos1};
    float4_nonbuiltin color_ramp_2_VAR_colors[2]{
        color_ramp_2_VAR_FROM_geo_dirt_color0,
        color_ramp_2_VAR_FROM_geo_dirt_color1};
    node_texture_valToRgb(
        2, color_ramp_2_VAR_positions, color_ramp_2_VAR_colors,
        COLBAND_BLEND_RGB, COLBAND_INTERP_LINEAR, COLBAND_HUE_NEAR,
        Noise_SPACE_Texture_DOT_001__Fac, &color_ramp_2_VAR__Color, NULL);
    ...
    float color_ramp_1_VAR_positions[2]{color_ramp_1_VAR_FROM_geo_dirt_pos0,
                                        color_ramp_1_VAR_FROM_geo_dirt_pos1};
    float4_nonbuiltin color_ramp_1_VAR_colors[2]{
        color_ramp_1_VAR_FROM_geo_dirt_color0,
        color_ramp_1_VAR_FROM_geo_dirt_color1};
    node_texture_valToRgb(
        2, color_ramp_1_VAR_positions, color_ramp_1_VAR_colors,
        COLBAND_BLEND_RGB, COLBAND_INTERP_LINEAR, COLBAND_HUE_NEAR,
        Voronoi_SPACE_Texture__Distance, &color_ramp_1_VAR__Color, NULL);
    float4_nonbuiltin Mix__Color;
    node_shader_mix_rgb(0, MA_RAMP_MIX, float(color_ramp_2_VAR__Color),
                        color_ramp_1_VAR__Color,
    ...
    node_shader_vector_math(
        NODE_VECTOR_MATH_ADD, Vector_SPACE_Math_DOT_006__Vector,
        Vector_SPACE_Math_DOT_007__Vector, float3_nonbuiltin(0.0, 0.0, 0.0),
    ...
    node_shader_vector_math(
        NODE_VECTOR_MATH_ADD, Vector_SPACE_Math_DOT_012__Vector,
        Vector_SPACE_Math_DOT_008__Vector, float3_nonbuiltin(0.0, 0.0, 0.0),
        1.0, &Vector_SPACE_Math_DOT_013__Vector, NULL);

    if (offset != NULL)
        *offset = Vector_SPACE_Math_DOT_013__Vector;
}
