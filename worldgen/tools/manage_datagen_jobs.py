...
def set_blender_path_global(args):
    ...
    if not os.path.exists(blender_path):
        raise ValueError(
            f'Couldnt not find {blender_path=}, make sure'
            ' --blender_path or $BLENDER is specified'
        )

    job_funcs.BLENDER_PATH = blender_path
