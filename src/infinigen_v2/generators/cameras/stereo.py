...
@pf.tracer.generator
def stereo_camera_rig_distribution(
    rng: pf.RNG,
...
@pf.tracer.grammar
def stereo_cameras_in_bbox_distribution(
    rng: pf.RNG,
    ...
    cameras = stereo_camera_rig_distribution(
