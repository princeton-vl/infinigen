...
def bookcase_geometry(
    ...
    div_boards = all_division_boards(
...
def bookcase_distribution(
    ...
    if metal_material is None:
        metal_material = metal_brushed.metal_brushed_linear_distribution(rng, vec)
