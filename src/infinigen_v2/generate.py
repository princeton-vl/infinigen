...
from infinigen_v2.exporters.realize_mesh import realize_scene
...
from infinigen_v2 import graph_json
...
def get_parser():
    """Get the argument parser for the infinigen_v2 generate command."""
...
def _execute_step(
    ...
    if pf.context.globals.current_trace_level is not None:
        varname = generator_func.__name__.removesuffix("_distribution")
