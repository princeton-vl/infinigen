...
class _GridWithIndicesResult(NamedTuple):
...
def shelf(
    ...
    grid_with_indices_result = _grid_with_indices(
    ...
    vert_board = _box_even(dimensions=vert_board_dimensions, origin=vert_board_origin)
