...
def glass_no_refraction_splats_rand(
    rng: pf.RNG,
    vector: t.SocketOrVal[pf.Vector],
) -> pf.Material:
    glass = glass_no_refraction.glass_no_refraction_rand(rng=rng, vector=vector)
    return splats_overlay_rand(
