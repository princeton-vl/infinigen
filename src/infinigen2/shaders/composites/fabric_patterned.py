...
__all__ = [
    "fabric_color_plain_rand",
    "fabric_patterned_colors_rand",
    "fabric_patterned_rand",
    "fabric_patterned_translucent_rand",
    "patterned_color_rand",
]


def fabric_patterned_colors_rand(
    rng: pf.RNG,
    ...
    plain_color1 = fabric_color_plain_rand(rngs[2], saturation=sat, value=val_plain)
    plain_color2 = fabric_color_plain_rand(rngs[3], saturation=sat, value=val_plain)
    color_bold = fabric_color_rand(rngs[4], value=val_bold)
...
def fabric_patterned_rand(
    ...
    if color1 is None:
        color1, color2, color3 = fabric_patterned_colors_rand(rngs[2])
    ...
    res = fabric_rand(rngs[8], vector=vector, base_color=color)
