...
def scratches_random_rand(
    ...
    scratch_thickness = scratch_spacing * pf.random.uniform(rng, 0.003, 0.015) * scale
    scratch_depth = scratch_thickness * pf.random.uniform(rng, 0.3, 1.0)
    distortion_size = 0.5
...
def scratches_linear_rand(
    ...
    scratch_thickness = scratch_spacing * pf.random.uniform(rng, 0.02, 0.1) * scale
    thickness_variation = pf.random.uniform(rng, 0.0, 0.413127)
    scratch_depth = scratch_thickness * pf.random.uniform(rng, 0.3, 1.0)
    noise_size = pf.random.uniform(rng, 4.0, 24.0)
    distortion_size = pf.random.uniform(rng, 2.0, 12.0)
