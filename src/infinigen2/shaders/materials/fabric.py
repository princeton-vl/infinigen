...
def fabric_presets(
    ...
    color = pf.control.choice(
        rng,
        [
            (pf.color.hsv_color((0.56, 0.25, 0.3)), 1),
            (pf.color.hsv_color((0.02, 0.25, 0.2)), 1),
            (pf.color.hsv_color((0.10, 0.5, 0.5)), 1),
            (pf.color.hsv_color((0.04, 0.15, 0.38)), 1),
        ],
    )
    func = pf.control.choice(
        rng,
        [
            (fabric_fine_preset, 1.0),
            (fabric_coarse_preset, 1.0),
        ],
    )
    return func(vector=vector, color=color)
