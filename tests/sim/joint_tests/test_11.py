...
def geometry_nodes(nw: NodeWrangler):
    ...
    cube = nw.new_node(Nodes.MeshCube, input_kwargs={"Size": (2.0000, 2.0000, 0.3000)})

    cube_1 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": (0.2000, 0.2000, 0.2000)}
    )
    ...
    transform_geometry = nw.new_node(
        ...
        input_kwargs={
            ...
            "Translation": (0.0000, 1.0000, 0.1500),
        },
    )
    ...
    transform_geometry_1 = nw.new_node(
        ...
        input_kwargs={
            ...
            "Translation": (0.0000, 0.0000, 0.7071),
            "Rotation": (0.0000, 0.7854, 0.0000),
        },
    )
...
class Test11Factory(AssetFactory):
    def __init__(self, factory_seed=None, coarse=False):
        super().__init__(factory_seed=factory_seed, coarse=False)

    @classmethod
    @gin.configurable(module="Test11Factory")
