...
import infinigen_v2.generators as _generators_pkg
...
_DETERMINISM_BLOCKED = {
    "livingroom_nofurniture_distribution": "needs procfunc bpy_nocollide_data_name fix (procfunc #131, arrives via 0.33 migration #733)",
    "livingroom_distribution": "needs procfunc #131 (#733); also a slow furnished build",
    "livingroom_with_smallobj_distribution": "needs procfunc #131 (#733); small-object cull determinism fixed here via deterministic pool naming (verified on the 0.33 stack)",
}
