...
from infinigen_v2.generators.scenes.collision_collection import (
    any_self_collision,
...
def test_collision_cube_passes_through(tmp_path, save_blend=True):
    ...
    Run with:
        uv run pytest tests/infinigen_v2/util/test_collision_collection.py::test_collision_cube_passes_through -v -s
    """
