...
def shader_coconut_green_shader(nw: NodeWrangler, basic_color, bottom_color):
    ...
    attribute_1 = nw.new_node(Nodes.Attribute, attrs={"attribute_name": "shape_coordinate"})
    ...
    attribute_2 = nw.new_node(Nodes.Attribute, attrs={"attribute_name": "crosssection_coordinate"})
...
def nodegroup_coconutgreen_surface(
    nw: NodeWrangler, basic_color=(0.2462, 0.4125, 0.0044, 1.0), bottom_color=(0.0908, 0.2664, 0.013, 1.0)
):
    # Code generated using version 2.4.3 of the node_transpiler
    ...
    surfacebump_1 = nw.new_node(
        nodegroup_surface_bump().name, input_kwargs={"Geometry": surfacebump, "Displacement": 0.0, "Scale": 10.0}
    )

    map_range = nw.new_node(
        Nodes.MapRange, input_kwargs={"Value": group_input.outputs["distance to center"], 1: 0.05, 2: 0.2, 4: 0.68}
    )
    ...
    set_material_3 = nw.new_node(
        ...
        input_kwargs={
            "Geometry": adddent,
            "Material": surface.shaderfunc_to_material(shader_coconut_green_shader, basic_color, bottom_color),
        },
    )

    group_output = nw.new_node(Nodes.GroupOutput, input_kwargs={"Geometry": set_material_3})
