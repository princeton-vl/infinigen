...
def shader_super_black_glass(nw: NodeWrangler):
    ...
    glossy_bsdf = nw.new_node(
        Nodes.GlossyBSDF, input_kwargs={"Color": (0.0095, 0.0095, 0.0095, 1.0000), "Roughness": 0.0000}
    )
    material_output = nw.new_node(
        Nodes.MaterialOutput, input_kwargs={"Surface": glossy_bsdf}, attrs={"is_active_output": True}
    )
