...
def shader_material(nw: NodeWrangler):
    ...
    noise_texture = nw.new_node(
        Nodes.NoiseTexture, input_kwargs={"Vector": mapping, "Scale": 2.0000, "Detail": 9.0000, "Roughness": roughness}
    )
    ...
    add = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: noise_texture.outputs["Color"], 1: dot_product.outputs["Value"]}
    )
