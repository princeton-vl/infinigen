...
def shader_bone(nw: NodeWrangler):
    ...
    noise_texture_1 = nw.new_node(
        Nodes.NoiseTexture, input_kwargs={"Vector": mapping_1, "Scale": 6.4000000000000004 + uniform(-1, 1) * 1}
    )
    ...
    principled_bsdf = nw.new_node(
        Nodes.PrincipledBSDF, input_kwargs={"Base Color": mix, "Roughness": 0.44090000000000001}
    )

    glass_bsdf = nw.new_node("ShaderNodeBsdfGlass")

    mix_shader = nw.new_node(Nodes.MixShader, input_kwargs={"Fac": 0.2, 1: principled_bsdf, 2: glass_bsdf})
