...
def nodegroup_UV(nw: NodeWrangler):
    ...
    subtract = nw.new_node(
        Nodes.Math, input_kwargs={0: 0.75, 1: separate_xyz.outputs["X"]}, attrs={"operation": "SUBTRACT"}
    )

    absolute = nw.new_node(Nodes.Math, input_kwargs={0: subtract}, attrs={"operation": "ABSOLUTE"})

    subtract_1 = nw.new_node(Nodes.Math, input_kwargs={1: absolute}, attrs={"operation": "SUBTRACT"})

    absolute_1 = nw.new_node(Nodes.Math, input_kwargs={0: subtract_1}, attrs={"operation": "ABSOLUTE"})

    multiply = nw.new_node(Nodes.Math, input_kwargs={0: absolute_1, 1: 2.0}, attrs={"operation": "MULTIPLY"})

    subtract_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: 1.0, 1: multiply}, attrs={"operation": "SUBTRACT", "use_clamp": True}
    )

    combine_xyz = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": subtract_2, "Y": separate_xyz.outputs["Y"]})
...
def nodegroup_scales(nw: NodeWrangler):
    ...
    separate_xyz_2 = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": group_input.outputs["Vector"]})

    multiply = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz_2.outputs["X"], 1: 10.0}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_1 = nw.new_node(Nodes.Math, input_kwargs={0: reroute_2, 1: cosine}, attrs={"operation": "MULTIPLY"})
    ...
    multiply_3 = nw.new_node(
        Nodes.Math, input_kwargs={0: subtract, 1: group_input_2.outputs["Xscale"]}, attrs={"operation": "MULTIPLY"}
    )

    noise_texture_2 = nw.new_node(
        Nodes.NoiseTexture, input_kwargs={"W": 0.8, "Scale": 10.0}, attrs={"noise_dimensions": "4D"}
    )
    ...
    multiply_5 = nw.new_node(Nodes.Math, input_kwargs={0: reroute_2, 1: sine}, attrs={"operation": "MULTIPLY"})
    ...
    multiply_7 = nw.new_node(
        Nodes.Math, input_kwargs={0: add_1, 1: group_input_2.outputs["Yscale"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    separate_xyz_7 = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": capture_attribute_1.outputs["Attribute"]})
    ...
    divide = nw.new_node(
        Nodes.Math, input_kwargs={0: subtract_8, 1: attribute_statistic.outputs["Range"]}, attrs={"operation": "DIVIDE"}
    )
    ...
    combine_xyz_3 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": divide, "Y": divide_1})
...
def shader_fish_body_regular(nw: NodeWrangler, rand=True, **input_kwargs):
    ...
    mapping_1 = nw.new_node(Nodes.Mapping, input_kwargs={"Vector": texture_coordinate_1.outputs["Generated"]})
    ...
    separate_xyz_2 = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": texture_coordinate_5.outputs["Normal"]})
    ...
    attribute_5 = nw.new_node(Nodes.Attribute, attrs={"attribute_name": "Color variations"})

    separate_xyz = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": attribute_5.outputs["Vector"]})

    multiply = nw.new_node(Nodes.Math, input_kwargs={0: separate_xyz.outputs["Y"]}, attrs={"operation": "MULTIPLY"})

    subtract = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["X"], 1: multiply}, attrs={"operation": "SUBTRACT"}
    )

    map_range = nw.new_node(Nodes.MapRange, input_kwargs={"Value": subtract, 1: -0.2})

    colorramp_12 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": map_range.outputs["Result"]})
    ...
    separate_xyz_1 = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": texture_coordinate_3.outputs["Generated"]})

    invert_1 = nw.new_node(Nodes.Invert, input_kwargs={"Color": separate_xyz_1.outputs["Z"]})

    subtract_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz_1.outputs["X"], 1: 0.57}, attrs={"operation": "SUBTRACT"}
    )

    absolute = nw.new_node(Nodes.Math, input_kwargs={0: subtract_1}, attrs={"operation": "ABSOLUTE"})

    multiply_1 = nw.new_node(Nodes.Math, input_kwargs={0: absolute, 1: 0.4}, attrs={"operation": "MULTIPLY"})

    map_range_1 = nw.new_node(Nodes.MapRange, input_kwargs={"Value": multiply_1})

    subtract_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: invert_1, 1: map_range_1.outputs["Result"]}, attrs={"operation": "SUBTRACT"}
    )

    add_1 = nw.new_node(Nodes.Math, input_kwargs={0: subtract_2, 1: 0.1})

    colorramp_13 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": map_range.outputs["Result"]})
    ...
    colorramp_8 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": wave_texture.outputs["Color"]})
    ...
    add_2 = nw.new_node(Nodes.Math, input_kwargs={0: colorramp_8.outputs["Color"], 1: -0.5})

    divide = nw.new_node(Nodes.Math, input_kwargs={0: add_2, 1: 2.0}, attrs={"operation": "DIVIDE"})

    invert = nw.new_node(Nodes.Invert, input_kwargs={"Color": separate_xyz_1.outputs["Z"]})
    if rand:
    ...
    mix_9 = nw.new_node(
        Nodes.MixRGB, input_kwargs={"Fac": add_1, "Color1": (0.021, 0.0158, 0.0026, 1.0), "Color2": mix_5}
    )
    ...
    colorramp_4 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": noise_texture_6.outputs["Fac"]})
    ...
    mix_4 = nw.new_node(
        Nodes.MixRGB, input_kwargs={"Fac": greater_than, "Color1": mix_11, "Color2": colorramp_7.outputs["Color"]}
    )
...
def shader_fish_body_gold(nw: NodeWrangler, rand=True, **input_kwargs):
    ...
    attribute = nw.new_node(Nodes.Attribute, attrs={"attribute_name": "Color variations"})
    ...
    greater_than = nw.new_node(
        Nodes.Math, input_kwargs={0: attribute_1.outputs["Vector"], 1: 0.01}, attrs={"operation": "GREATER_THAN"}
    )
    ...
    colorramp_2 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": wave_texture.outputs["Color"]})
    ...
    add = nw.new_node(Nodes.Math, input_kwargs={0: colorramp_2.outputs["Color"], 1: -0.0})

    divide = nw.new_node(Nodes.Math, input_kwargs={0: add, 1: 2.0}, attrs={"operation": "DIVIDE"})

    texture_coordinate_1 = nw.new_node(Nodes.TextureCoord)

    separate_xyz_1 = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": texture_coordinate_1.outputs["Generated"]})

    invert = nw.new_node(Nodes.Invert, input_kwargs={"Fac": 0.5593, "Color": separate_xyz_1.outputs["Z"]})
    if rand:
        invert.inputs["Fac"].default_value = sample_range(0.5, 1)
    ...
    colorramp_5 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": colorramp_4.outputs["Color"]})
    ...
    colorramp_6 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": noise_texture_1.outputs["Fac"]})
    ...
    mix_4 = nw.new_node(
        Nodes.MixRGB, input_kwargs={"Fac": colorramp.outputs["Color"], "Color1": (1.0, 1.0, 1.0, 1.0), "Color2": mix_3}
    )
...
def geometry_fish_body(nw: NodeWrangler, rand=True, **input_kwargs):
    ...
    noise_texture = nw.new_node(Nodes.NoiseTexture, input_kwargs={"Scale": 50.0}, attrs={"noise_dimensions": "4D"})
    if rand:
        noise_texture.inputs["W"].default_value = sample_range(-2, 2)
    ...
    multiply = nw.new_node(Nodes.VectorMath, input_kwargs={0: add, 1: normal}, attrs={"operation": "MULTIPLY"})
    ...
    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": scales.outputs["Geometry"], "Offset": multiply_1.outputs["Vector"]}
    )

    group_output = nw.new_node(
        Nodes.GroupOutput,
        input_kwargs={"Geometry": set_position, "attr2": scales.outputs["attr2"], "attr5": scales.outputs["attr5"]},
    )
...
def nodegroup_gradient_color(nw: NodeWrangler, **input_args):
    ...
    map_range = nw.new_node(Nodes.MapRange, input_kwargs={"Value": subtract, 1: group_input.outputs["Value1"]})
    ...
    group_output = nw.new_node(Nodes.GroupOutput, input_kwargs={"Color": colorramp_1.outputs["Color"]})
...
def nodegroup_noise_color(nw: NodeWrangler):
    ...
    mapping_3 = nw.new_node(Nodes.Mapping, input_kwargs={"Vector": texture_coordinate_3.outputs["Generated"]})
    ...
    colorramp_9 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": noise_texture_8.outputs["Fac"]})
...
def shader_stripe_fish(nw: NodeWrangler, rand=True, **input_kwargs):
    ...
    colorramp_11 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": attribute_6.outputs["Color"]})
    ...
    mapping_4 = nw.new_node(Nodes.Mapping, input_kwargs={"Vector": texture_coordinate_2.outputs["Generated"]})

    noise_texture_9 = nw.new_node(Nodes.NoiseTexture, input_kwargs={"Vector": mapping_4, "Scale": N(10, 2)})

    colorramp_10 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": noise_texture_9.outputs["Fac"]})
    ...
    mapping_2 = nw.new_node(Nodes.Mapping, input_kwargs={"Vector": texture_coordinate_2.outputs["Generated"]})

    separate_xyz_1 = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": mapping_2})

    subtract = nw.new_node(Nodes.Math, input_kwargs={0: separate_xyz_1.outputs["Z"]}, attrs={"operation": "SUBTRACT"})

    power = nw.new_node(
        Nodes.Math, input_kwargs={0: subtract, 1: 4.0 if U() < 0.7 else 3.0}, attrs={"operation": "POWER"}
    )

    multiply = nw.new_node(Nodes.Math, input_kwargs={0: power, 1: U(-2, 3)}, attrs={"operation": "MULTIPLY"})

    add = nw.new_node(Nodes.Math, input_kwargs={0: separate_xyz_1.outputs["X"], 1: multiply})

    combine_xyz = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": add, "Y": separate_xyz_1.outputs["Y"], "Z": separate_xyz_1.outputs["Z"]}
    )
    ...
    multiply_1 = nw.new_node(Nodes.Math, input_kwargs={0: offset, 1: -1.0}, attrs={"operation": "MULTIPLY"})
    ...
    colorramp_8 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": wave_texture_2.outputs["Color"]})
    ...
    colorramp_6 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": wave_texture_1.outputs["Color"]})
    ...
    colorramp_5 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": wave_texture.outputs["Color"]})
    ...
    mix_8 = nw.new_node(
        Nodes.MixRGB, input_kwargs={"Fac": colorramp_5.outputs["Color"], "Color1": group_1, "Color2": group}
    )

    side_stripe_color = (U(), U(), U(), 1.0)
    mix_9 = nw.new_node(
        Nodes.MixRGB, input_kwargs={"Fac": colorramp_6.outputs["Color"], "Color1": side_stripe_color, "Color2": mix_8}
    )

    mix_10 = nw.new_node(
        Nodes.MixRGB, input_kwargs={"Fac": colorramp_8.outputs["Color"], "Color1": side_stripe_color, "Color2": mix_9}
    )
    ...
    roughness = U(0, 0.5)
    colorramp_14 = nw.new_node(Nodes.ColorRamp, input_kwargs={"Fac": noise_texture_7.outputs["Fac"]})
    colorramp_14.color_ramp.elements[0].position = 0.0
    colorramp_14.color_ramp.elements[0].color = (0.0, 0.0, 0.0, 1.0)
