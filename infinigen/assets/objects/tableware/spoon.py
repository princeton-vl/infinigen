...
def _spoon_legacy_init(inst: Any, seed: int, coarse: bool) -> None:
    TablewareFactory.__init__(inst, seed, coarse)
    inst.x_length = log_uniform(0.2, 0.8)
    inst.y_length = log_uniform(0.06, 0.12)
    inst.z_depth = log_uniform(0.08, 0.25)
...
class SpoonParameters(LegacyBridgeParameters):
    pass
