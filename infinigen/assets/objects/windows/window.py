...
from infinigen.assets.materials import metal_shader_list, wood_shader_list, glass_shader_list
...
class WindowFactory(AssetFactory):
    def __init__(self, factory_seed, dimensions=None, coarse=False, open=None, curtain=None, shutter=None):
    ...
    def sample_parameters(dimensions, open, curtain, shutter):
        ...
        sub_panel_height = max(min(sub_panel_height, 2 * sub_panel_width), 0.5 * sub_panel_width)
        ...
        shader_glass_material_choice = random.choice(glass_shader_list)
        ...
        params = {
            ...
            "FrameMaterial": surface.shaderfunc_to_material(shader_frame_material_choice),
            ...
            "Material": surface.shaderfunc_to_material(shader_glass_material_choice)
        }
        return params
...
def nodegroup_window_geometry(nw: NodeWrangler):
    ...
    group_input_1 = nw.new_node(Nodes.GroupInput,
        expose_input=[('NodeSocketFloatDistance', 'Width', 2.0000),
            ...
            ('NodeSocketMaterial', 'FrameMaterial', surface.shaderfunc_to_material(shader_frame_material)),
            ('NodeSocketMaterial', 'CurtainFrameMaterial', surface.shaderfunc_to_material(shader_curtain_frame_material)),
            ('NodeSocketMaterial', 'CurtainMaterial', surface.shaderfunc_to_material(shader_curtain_material)),
            ('NodeSocketMaterial', 'Material', surface.shaderfunc_to_material(shader_glass_material))])
    
    windowpanel = nw.new_node(nodegroup_window_panel().name,
        input_kwargs={'Width': group_input_1.outputs["Width"], 'Height': group_input_1.outputs["Height"], 'FrameWidth': group_input_1.outputs["FrameWidth"], 'FrameThickness': group_input_1.outputs["FrameThickness"], 'PanelWidth': group_input_1.outputs["FrameWidth"], 'PanelThickness': group_input_1.outputs["FrameThickness"], 'PanelHAmount': group_input_1.outputs["PanelHAmount"], 'PanelVAmount': group_input_1.outputs["PanelVAmount"], 'FrameMaterial': group_input_1.outputs["FrameMaterial"], 'Material': group_input_1.outputs["Material"]})
    
    multiply = nw.new_node(Nodes.Math,
        input_kwargs={0: group_input_1.outputs["FrameWidth"], 1: group_input_1.outputs["PanelVAmount"]},
    ...
    multiply_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: group_input_1.outputs["FrameWidth"], 1: group_input_1.outputs["PanelHAmount"]},
        attrs={'operation': 'MULTIPLY'})
    ...
    windowpanel_1 = nw.new_node(nodegroup_window_panel().name,
        input_kwargs={'Width': subtract_1, 'Height': subtract_3, 'FrameWidth': group_input_1.outputs["SubFrameWidth"], 'FrameThickness': group_input_1.outputs["SubFrameThickness"], 'PanelWidth': group_input_1.outputs["SubFrameWidth"], 'PanelThickness': group_input_1.outputs["SubFrameThickness"], 'PanelHAmount': group_input_1.outputs["SubPanelHAmount"], 'PanelVAmount': group_input_1.outputs["SubPanelVAmount"], 'WithGlass': True, 'GlassThickness': group_input_1.outputs["GlassThickness"], 'FrameMaterial': group_input_1.outputs["FrameMaterial"], 'Material': group_input_1.outputs["Material"]})
    
    windowshutter = nw.new_node(nodegroup_window_shutter().name,
        input_kwargs={'Width': subtract_1, 'Height': subtract_3, 'FrameWidth': group_input_1.outputs["FrameWidth"], 'FrameThickness': group_input_1.outputs["FrameThickness"], 'PanelWidth': group_input_1.outputs["ShutterPanelRadius"], 'PanelThickness': group_input_1.outputs["ShutterPanelRadius"], 'ShutterWidth': group_input_1.outputs["ShutterWidth"], 'ShutterThickness': group_input_1.outputs["ShutterThickness"], 'ShutterInterval': group_input_1.outputs["ShutterInterval"], 'ShutterRotation': group_input_1.outputs["ShutterRotation"], 'FrameMaterial': group_input_1.outputs["FrameMaterial"]})
    
    switch = nw.new_node(Nodes.Switch, input_kwargs={1: group_input_1.outputs["Shutter"], 14: windowpanel_1, 15: windowshutter})
    ...
    divide_2 = nw.new_node(Nodes.Math,
        input_kwargs={0: group_input_1.outputs["Width"], 1: group_input_1.outputs["PanelVAmount"]},
        attrs={'operation': 'DIVIDE'})
    ...
    divide_3 = nw.new_node(Nodes.Math,
        input_kwargs={0: group_input_1.outputs["Height"], 1: group_input_1.outputs["PanelHAmount"]},
        attrs={'operation': 'DIVIDE'})
    ...
    transform = nw.new_node(Nodes.Transform, input_kwargs={'Geometry': switch.outputs[6], 'Translation': combine_xyz})
    ...
    multiply_6 = nw.new_node(Nodes.Math,
        input_kwargs={0: group_input_1.outputs["PanelHAmount"], 1: group_input_1.outputs["PanelVAmount"]},
        attrs={'operation': 'MULTIPLY'})
    ...
    combine_xyz_1 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'X': multiply_7, 'Y': multiply_8, 'Z': multiply_9})
    
    set_position = nw.new_node(Nodes.SetPosition,
        input_kwargs={'Geometry': duplicate_elements.outputs["Geometry"], 'Offset': combine_xyz_1})
    ...
    multiply_11 = nw.new_node(Nodes.Math, input_kwargs={0: divide, 1: modulo_1}, attrs={'operation': 'MULTIPLY'})
    ...
    multiply_12 = nw.new_node(Nodes.Math, input_kwargs={0: divide_1, 1: modulo_2}, attrs={'operation': 'MULTIPLY'})
    ...
    rotate_instances = nw.new_node(Nodes.RotateInstances,
        input_kwargs={'Instances': set_position, 'Rotation': combine_xyz_3, 'Pivot Point': combine_xyz_2})
    
    multiply_13 = nw.new_node(Nodes.Math, input_kwargs={0: group_input_1.outputs["OpenHAngle"]}, attrs={'operation': 'MULTIPLY'})
    
    combine_xyz_5 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'X': multiply_13})
    
    multiply_14 = nw.new_node(Nodes.Math, input_kwargs={0: add_3, 1: -1.000}, attrs={'operation': 'MULTIPLY'})
    ...
    rotate_instances_1 = nw.new_node(Nodes.RotateInstances,
        input_kwargs={'Instances': rotate_instances, 'Rotation': combine_xyz_5, 'Pivot Point': combine_xyz_6})
    ...
    set_position_1 = nw.new_node(Nodes.SetPosition, input_kwargs={'Geometry': rotate_instances_1, 'Offset': combine_xyz_4})
    
    join_geometry = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [windowpanel, set_position_1]})
    
    multiply_16 = nw.new_node(Nodes.Math, input_kwargs={0: group_input_1.outputs["Width"]}, attrs={'operation': 'MULTIPLY'})
    
    multiply_17 = nw.new_node(Nodes.Math, input_kwargs={0: multiply_16, 1: -1.0000}, attrs={'operation': 'MULTIPLY'})
    
    multiply_18 = nw.new_node(Nodes.Math,
        input_kwargs={0: group_input_1.outputs["CurtainFrameDepth"], 1: -1.0000},
        attrs={'operation': 'MULTIPLY'})
    
    curtain = nw.new_node(nodegroup_curtain().name,
        input_kwargs={'Width': group_input_1.outputs["Width"], 'Depth': group_input_1.outputs["CurtainDepth"], 'Height': group_input_1.outputs["Height"], 'IntervalNumber': group_input_1.outputs["CurtainIntervalNumber"], 'Radius': group_input_1.outputs["CurtainFrameRadius"], 'L1': multiply_17, 'R1': group_input_1.outputs["CurtainMidL"], 'L2': group_input_1.outputs["CurtainMidR"], 'R2': multiply_16, 'FrameDepth': multiply_18, 'CurtainFrameMaterial': group_input_1.outputs["CurtainFrameMaterial"], 'CurtainMaterial': group_input_1.outputs["CurtainMaterial"]})
    
    multiply_19 = nw.new_node(Nodes.Math, input_kwargs={0: group_input_1.outputs["FrameThickness"]}, attrs={'operation': 'MULTIPLY'})
    
    add_6 = nw.new_node(Nodes.Math, input_kwargs={0: group_input_1.outputs["CurtainFrameDepth"], 1: multiply_19})
    
    combine_xyz_7 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'Z': add_6})
    
    transform_geometry = nw.new_node(Nodes.Transform, input_kwargs={'Geometry': curtain, 'Translation': combine_xyz_7})
    ...
    switch_1 = nw.new_node(Nodes.Switch,
        input_kwargs={1: group_input_1.outputs["Curtain"], 14: join_geometry, 15: join_geometry_1})
    ...
    group_output = nw.new_node(Nodes.GroupOutput,
        input_kwargs={'Geometry': realize_instances, 'Bounding Box': bounding_box.outputs["Bounding Box"]},
        attrs={'is_active_output': True})
...
def nodegroup_line_seq(nw: NodeWrangler):
    ...
    group_input = nw.new_node(Nodes.GroupInput,
        expose_input=[('NodeSocketFloat', 'Width', -1.0000),
    ...
    multiply_1 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: -0.5000}, attrs={'operation': 'MULTIPLY'})
    
    combine_xyz = nw.new_node(Nodes.CombineXYZ, input_kwargs={'X': multiply, 'Y': multiply_1})
    
    multiply_2 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["Width"], 1: -0.5000}, attrs={'operation': 'MULTIPLY'})
    ...
    divide = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: add_1}, attrs={'operation': 'DIVIDE'})
    ...
    set_position = nw.new_node(Nodes.SetPosition,
        input_kwargs={'Geometry': duplicate_elements.outputs["Geometry"], 'Offset': combine_xyz_2})
    
    group_output = nw.new_node(Nodes.GroupOutput, input_kwargs={'Curve': set_position}, attrs={'is_active_output': True})
...
def nodegroup_curtain(nw: NodeWrangler):
    ...
    multiply_1 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["Width"]}, attrs={'operation': 'MULTIPLY'})
    ...
    set_position_2 = nw.new_node(Nodes.SetPosition,
        input_kwargs={'Geometry': ico_sphere.outputs["Mesh"], 'Offset': sample_curve_1.outputs["Position"]})
    
    combine_xyz_9 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'X': multiply_1, 'Z': group_input.outputs["FrameDepth"]})
    
    curve_line_4 = nw.new_node(Nodes.CurveLine, input_kwargs={'Start': combine_xyz_1, 'End': combine_xyz_9})
    
    combine_xyz_8 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'X': multiply_2, 'Z': group_input.outputs["FrameDepth"]})
    
    curve_line_3 = nw.new_node(Nodes.CurveLine, input_kwargs={'Start': combine_xyz, 'End': combine_xyz_8})
    
    join_geometry_3 = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [curve_line, curve_line_4, curve_line_3]})
    ...
    curve_to_mesh_1 = nw.new_node(Nodes.CurveToMesh,
        input_kwargs={'Curve': join_geometry_3, 'Profile Curve': curve_circle.outputs["Curve"], 'Fill Caps': True})
    ...
    set_position_3 = nw.new_node(Nodes.SetPosition,
        input_kwargs={'Geometry': ico_sphere_1.outputs["Mesh"], 'Offset': sample_curve.outputs["Position"]})
    
    join_geometry_2 = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [set_position_2, curve_to_mesh_1, set_position_3]})
    
    multiply_3 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: -0.4700}, attrs={'operation': 'MULTIPLY'})
    
    combine_xyz_3 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'Y': multiply_3})
    
    set_position_1 = nw.new_node(Nodes.SetPosition, input_kwargs={'Geometry': join_geometry_2, 'Offset': combine_xyz_3})
    
    set_material_1 = nw.new_node(Nodes.SetMaterial,
        input_kwargs={'Geometry': set_position_1, 'Material': group_input.outputs["CurtainFrameMaterial"]})
    ...
    join_geometry_1 = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [resample_curve, resample_curve_1]})
    
    spline_parameter_1 = nw.new_node(Nodes.SplineParameter)
    
    capture_attribute = nw.new_node(Nodes.CaptureAttribute,
        input_kwargs={'Geometry': join_geometry_1, 2: spline_parameter_1.outputs["Factor"]})
    ...
    divide = nw.new_node(Nodes.Math, input_kwargs={0: multiply_4, 1: group_input.outputs["Width"]}, attrs={'operation': 'DIVIDE'})
    ...
    multiply_6 = nw.new_node(Nodes.Math, input_kwargs={0: sine, 1: group_input.outputs["Depth"]}, attrs={'operation': 'MULTIPLY'})
    
    combine_xyz_2 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'Z': multiply_6})
    
    set_position = nw.new_node(Nodes.SetPosition,
        input_kwargs={'Geometry': capture_attribute.outputs["Geometry"], 'Offset': combine_xyz_2})
    ...
    divide_1 = nw.new_node(Nodes.Math, input_kwargs={0: separate_xyz.outputs["X"], 1: reroute}, attrs={'operation': 'DIVIDE'})
    
    capture_attribute_1 = nw.new_node(Nodes.CaptureAttribute, input_kwargs={'Geometry': quadrilateral, 2: divide_1})
    
    curve_to_mesh = nw.new_node(Nodes.CurveToMesh,
        input_kwargs={'Curve': set_position, 'Profile Curve': capture_attribute_1.outputs["Geometry"]})
    ...
    set_material = nw.new_node(Nodes.SetMaterial,
        input_kwargs={'Geometry': store_named_attribute, 'Material': group_input.outputs["CurtainMaterial"]})
    
    multiply_7 = nw.new_node(Nodes.Math, input_kwargs={0: reroute_1, 1: 1.3000}, attrs={'operation': 'MULTIPLY'})
    ...
    set_position_4 = nw.new_node(Nodes.SetPosition, input_kwargs={'Geometry': curve_to_mesh_2, 'Offset': combine_xyz_10})
    
    difference = nw.new_node(Nodes.MeshBoolean, input_kwargs={'Mesh 1': set_material, 'Mesh 2': set_position_4})
    
    join_geometry = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [set_material_1, difference.outputs["Mesh"]]})
...
def nodegroup_window_shutter(nw: NodeWrangler):
    ...
    quadrilateral_1 = nw.new_node('GeometryNodeCurvePrimitiveQuadrilateral',
        input_kwargs={'Width': multiply, 'Height': group_input.outputs["FrameThickness"]})
    
    curve_to_mesh = nw.new_node(Nodes.CurveToMesh, input_kwargs={'Curve': quadrilateral, 'Profile Curve': quadrilateral_1})
    ...
    combine_xyz = nw.new_node(Nodes.CombineXYZ,
        input_kwargs={'X': subtract, 'Y': group_input.outputs["ShutterWidth"], 'Z': group_input.outputs["ShutterThickness"]})
    
    cube = nw.new_node(Nodes.MeshCube, input_kwargs={'Size': combine_xyz})
    
    geometry_to_instance = nw.new_node('GeometryNodeGeometryToInstance', input_kwargs={'Geometry': cube.outputs["Mesh"]})
    
    subtract_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: group_input.outputs["Height"], 1: group_input.outputs["FrameWidth"]},
        attrs={'operation': 'SUBTRACT'})
    ...
    shutter_number = nw.new_node(Nodes.Math, input_kwargs={0: floor, 1: 1.0000}, label='ShutterNumber', attrs={'operation': 'SUBTRACT'})
    
    duplicate_elements = nw.new_node(Nodes.DuplicateElements,
        input_kwargs={'Geometry': geometry_to_instance, 'Amount': shutter_number},
        attrs={'domain': 'INSTANCE'})
    
    shutter_true_interval = nw.new_node(Nodes.Math,
        input_kwargs={0: subtract_1, 1: floor},
        label='ShutterTrueInterval',
        attrs={'operation': 'DIVIDE'})
    
    multiply_1 = nw.new_node(Nodes.Math,
        input_kwargs={0: duplicate_elements.outputs["Duplicate Index"], 1: shutter_true_interval},
        attrs={'operation': 'MULTIPLY'})
    
    multiply_2 = nw.new_node(Nodes.Math, input_kwargs={0: subtract_1, 1: -0.5000}, attrs={'operation': 'MULTIPLY'})
    ...
    rotate_instances = nw.new_node(Nodes.RotateInstances, input_kwargs={'Instances': set_position, 'Rotation': combine_xyz_5})
    
    multiply_3 = nw.new_node(Nodes.Math, input_kwargs={0: shutter_true_interval, 1: 2.0000}, attrs={'operation': 'MULTIPLY'})
    
    subtract_2 = nw.new_node(Nodes.Math, input_kwargs={0: subtract_1, 1: multiply_3}, attrs={'operation': 'SUBTRACT'})
    
    combine_xyz_2 = nw.new_node(Nodes.CombineXYZ,
        input_kwargs={'X': group_input.outputs["PanelWidth"], 'Y': subtract_2, 'Z': group_input.outputs["PanelThickness"]})
    
    cube_1 = nw.new_node(Nodes.MeshCube, input_kwargs={'Size': combine_xyz_2})
    
    multiply_4 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["ShutterWidth"]}, attrs={'operation': 'MULTIPLY'})
    ...
    geometry_to_instance_1 = nw.new_node('GeometryNodeGeometryToInstance', input_kwargs={'Geometry': curve_line})
    
    combine_xyz_4 = nw.new_node(Nodes.CombineXYZ, input_kwargs={'X': reroute})
    
    rotate_instances_1 = nw.new_node(Nodes.RotateInstances, input_kwargs={'Instances': geometry_to_instance_1, 'Rotation': combine_xyz_4})
    ...
    set_position_1 = nw.new_node(Nodes.SetPosition,
        input_kwargs={'Geometry': cube_1.outputs["Mesh"], 'Offset': sample_curve.outputs["Position"]})
    
    join_geometry_2 = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [curve_to_mesh, rotate_instances, set_position_1]})
    
    set_material = nw.new_node(Nodes.SetMaterial,
        input_kwargs={'Geometry': join_geometry_2, 'Material': group_input.outputs["FrameMaterial"]})
...
def nodegroup_window_panel(nw: NodeWrangler):
    ...
    lineseq = nw.new_node(nodegroup_line_seq().name,
        input_kwargs={'Width': group_input.outputs["Width"], 'Height': group_input.outputs["Height"], 'Amount': add})
    ...
    quadrilateral_2 = nw.new_node('GeometryNodeCurvePrimitiveQuadrilateral', input_kwargs={'Width': reroute, 'Height': subtract})
    
    curve_to_mesh_1 = nw.new_node(Nodes.CurveToMesh, input_kwargs={'Curve': lineseq, 'Profile Curve': quadrilateral_2})
    
    add_1 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["PanelVAmount"], 1: -1.0000})
    
    lineseq_1 = nw.new_node(nodegroup_line_seq().name,
        input_kwargs={'Width': group_input.outputs["Height"], 'Height': group_input.outputs["Width"], 'Amount': add_1})
    
    transform = nw.new_node(Nodes.Transform, input_kwargs={'Geometry': lineseq_1, 'Rotation': (0.0000, 0.0000, 1.5708)})
    
    subtract_1 = nw.new_node(Nodes.Math, input_kwargs={0: subtract, 1: 0.0010}, attrs={'operation': 'SUBTRACT'})
    
    quadrilateral_3 = nw.new_node('GeometryNodeCurvePrimitiveQuadrilateral', input_kwargs={'Width': reroute, 'Height': subtract_1})
    
    curve_to_mesh_2 = nw.new_node(Nodes.CurveToMesh, input_kwargs={'Curve': transform, 'Profile Curve': quadrilateral_3})
    
    join_geometry_3 = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [curve_to_mesh_1, curve_to_mesh_2]})
    
    join_geometry_2 = nw.new_node(Nodes.JoinGeometry, input_kwargs={'Geometry': [curve_to_mesh, join_geometry_3]})
    
    set_material_1 = nw.new_node(Nodes.SetMaterial,
        input_kwargs={'Geometry': join_geometry_2, 'Material': group_input.outputs["FrameMaterial"]})
    
    combine_xyz = nw.new_node(Nodes.CombineXYZ,
        input_kwargs={'X': group_input.outputs["Width"], 'Y': group_input.outputs["Height"], 'Z': group_input.outputs["GlassThickness"]})
    ...
    switch = nw.new_node(Nodes.Switch,
        input_kwargs={1: group_input.outputs["WithGlass"], 14: set_material_1, 15: join_geometry})
    
    set_shade_smooth = nw.new_node(Nodes.SetShadeSmooth, input_kwargs={'Geometry': switch.outputs[6], 'Shade Smooth': False})
...
def shader_glass_material(nw: NodeWrangler):
    ...
    principled_bsdf = nw.new_node(Nodes.PrincipledBSDF,
        input_kwargs={'Base Color': (0.0094, 0.0055, 0.8000, 1.0000), 'Roughness': 0.0000})
...
def shader_curtain_material(nw: NodeWrangler):
    ...
    principled_bsdf = nw.new_node(Nodes.PrincipledBSDF, input_kwargs={'Base Color': (0.8000, 0.0013, 0.3926, 1.0000)})
...
def shader_curtain_frame_material(nw: NodeWrangler):
    ...
    principled_bsdf = nw.new_node(Nodes.PrincipledBSDF, input_kwargs={'Base Color': (0.1840, 0.0000, 0.8000, 1.0000)})
...
def shader_frame_material(nw: NodeWrangler):
    ...
    principled_bsdf = nw.new_node(Nodes.PrincipledBSDF, input_kwargs={'Base Color': (0.8000, 0.5033, 0.0057, 1.0000)})
...
def shader_wood(nw: NodeWrangler):
    ...
    mapping = nw.new_node(Nodes.Mapping,
        input_kwargs={'Vector': texture_coordinate.outputs["Object"], 'Location': value, 'Rotation': (5.2370, 5.6072, 6.0194)})
    
    mapping_1 = nw.new_node(Nodes.Mapping, input_kwargs={'Vector': mapping, 'Scale': (2.9513, 8.5182, 3.9889)})
