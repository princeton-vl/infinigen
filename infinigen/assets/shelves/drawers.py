...
def nodegroup_board_rail(nw: NodeWrangler):
    ...
    cylinder_1 = nw.new_node(
        "GeometryNodeMeshCylinder", input_kwargs={"Vertices": 64, "Radius": 0.0040, "Depth": 0.0050}
    )
    ...
    combine_xyz = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": 0.0020, "Y": subtract, "Z": group_input.outputs["width"]}
    )
    ...
    cylinder = nw.new_node(
        "GeometryNodeMeshCylinder", input_kwargs={"Vertices": 64, "Radius": 0.0030, "Depth": subtract}
    )
    ...
    transform_2 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": transform_1, "Scale": (1.0000, 1.0000, -1.0000)}
    )

    join_geometry_2 = nw.new_node(Nodes.JoinGeometry, input_kwargs={"Geometry": [transform_2, transform_1]})

    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [transform_5, transform, join_geometry_2]}
    )
    ...
    transform_4 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": transform_3, "Scale": (-1.0000, 1.0000, 1.0000)}
    )
...
def nodegroup_kallax_drawer_frame(nw: NodeWrangler):
    ...
    cube = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz, "Vertices X": 4, "Vertices Y": 4, "Vertices Z": 4}
    )
    ...
    transform = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_1, "Translation": combine_xyz_1}
    )
    ...
    cube_1 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz_2, "Vertices X": 4, "Vertices Y": 4, "Vertices Z": 4}
    )
    ...
    multiply_add_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: add_1, 1: -0.5000, 2: -0.0001}, attrs={"operation": "MULTIPLY_ADD"}
    )

    combine_xyz_3 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"Y": multiply_add_1, "Z": 0.0100})

    transform_2 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_2, "Translation": combine_xyz_3}
    )

    combine_xyz_4 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": add_3, "Y": add, "Z": add_2})

    cube_2 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz_4, "Vertices X": 4, "Vertices Y": 4, "Vertices Z": 4}
    )
    ...
    multiply_add_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: add_1, 1: -1.0000, 2: multiply_2}, attrs={"operation": "MULTIPLY_ADD"}
    )
    ...
    transform_3 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute, "Translation": combine_xyz_5}
    )

    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [transform_1, transform, transform_2, transform_3]}
    )
...
def nodegroup_door_knob(nw: NodeWrangler):
    ...
    cylinder = nw.new_node(
        "GeometryNodeMeshCylinder", input_kwargs={"Vertices": 64, "Radius": group_input.outputs["Radius"], "Depth": add}
    )
...
def geometry_nodes(nw: NodeWrangler, **kwargs):
    ...
    drawer_door_board = nw.new_node(
        ...
        input_kwargs={"thickness": door_thickness, "width": drawer_board_width, "height": drawer_board_height},
    )
    ...
    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [door_knob, drawer_door_board, kallax_drawer_frame]}
    )

    set_material_2 = nw.new_node(
        Nodes.SetMaterial,
        input_kwargs={"Geometry": join_geometry, "Material": surface.shaderfunc_to_material(kwargs["frame_material"])},
    )
