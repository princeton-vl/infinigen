...
class OvenFactory(AssetFactory):
    ...
    def create_placeholder(self, **kwargs) -> bpy.types.Object:
        ...
        return butil.modify_mesh(
            obj,
            "NODES",
            node_group=nodegroup_oven_geometry(use_gas=self.params["UseGas"], is_placeholder=True),
    ...
    def create_asset(self, **params):
        ...
        butil.modify_mesh(
            obj,
            "NODES",
            node_group=nodegroup_oven_geometry(preprocess=True, use_gas=self.params["UseGas"]),
            ng_inputs=self.geometry_node_params,
            apply=True,
        )
...
def gas_grates(width, depth, grate_width, grate_depth, height, thickness, grids, branches, center_ratio, middle_ratio):
    ...
    for i, n in enumerate(grids):
        cubes = [
            butil.spawn_cube(
                size=1,
                location=(depth / 2, grate_width / len(grids) * i + (width - grate_width) / 2 + thickness / 2, height),
            ...
            butil.spawn_cube(
                ...
                location=(
                    depth / 2,
                    grate_width / len(grids) * (i + 1) + (width - grate_width) / 2 - thickness / 2,
                    height,
                ),
                scale=(grate_depth + thickness, thickness, thickness),
                name=None,
        ...
        for j in range(n):
            ...
            for k in range(branches):
                ...
                cubes.append(obj)
            grates.append(
                butil.spawn_cylinder(center_dist + thickness, thickness / 2, location=(center[0], center[1], height))
            )
...
def nodegroup_hollow_cube(nw: NodeWrangler):
    ...
    subtract = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["Y"], 1: multiply}, attrs={"operation": "SUBTRACT"}
    )

    subtract_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["Z"], 1: multiply}, attrs={"operation": "SUBTRACT"}
    )

    combine_xyz_4 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": group_input.outputs["Thickness"], "Y": subtract, "Z": subtract_1}
    )
    ...
    scale = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: group_input.outputs["Size"], "Scale": 0.5000}, attrs={"operation": "SCALE"}
    )
    ...
    transform_2 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_1, "Translation": combine_xyz_5}
    )
    ...
    subtract_4 = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["Z"], 1: multiply_1}, attrs={"operation": "SUBTRACT"}
    )

    combine_xyz_3 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": add_2, "Y": add_3, "Z": subtract_4})

    transform_1 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_4, "Translation": combine_xyz_3}
    )
    ...
    combine_xyz_6 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": group_input.outputs["Thickness"], "Y": subtract_6, "Z": subtract_7}
    )
    ...
    subtract_8 = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["X"], 1: multiply_1}, attrs={"operation": "SUBTRACT"}
    )
    ...
    transform_3 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_5, "Translation": combine_xyz_7}
    )
    ...
    transform_4 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_2, "Translation": combine_xyz_8}
    )
    ...
    subtract_10 = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["Y"], 1: multiply_1}, attrs={"operation": "SUBTRACT"}
    )
    ...
    transform_5 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_3, "Translation": combine_xyz_11}
    )
...
def nodegroup_o(nw: NodeWrangler):
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Mesh": extrude_mesh.outputs["Mesh"]}, attrs={"is_active_output": True}
    )
...
def nodegroup_heater(nw: NodeWrangler):
    ...
    divide = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["width"], 1: multiply_1}, attrs={"operation": "DIVIDE"}
    )

    floor = nw.new_node(Nodes.Math, input_kwargs={0: divide}, attrs={"operation": "FLOOR"})

    divide_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["depth"], 1: multiply_1}, attrs={"operation": "DIVIDE"}
    )
    ...
    divide_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["depth"], 1: floor_1}, attrs={"operation": "DIVIDE"}
    )
    ...
    multiply_add = nw.new_node(
        Nodes.Math, input_kwargs={0: divide_2, 2: multiply_3}, attrs={"operation": "MULTIPLY_ADD"}
    )

    divide_4 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["width"], 1: floor}, attrs={"operation": "DIVIDE"}
    )
    ...
    multiply_add_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: divide_4, 2: multiply_4}, attrs={"operation": "MULTIPLY_ADD"}
    )

    combine_xyz = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": multiply_add, "Y": multiply_add_1})

    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": duplicate_elements.outputs["Geometry"], "Offset": combine_xyz}
    )
...
def nodegroup_oven_rack(nw: NodeWrangler):
    ...
    multiply_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    divide = nw.new_node(
        Nodes.Math, input_kwargs={0: multiply_2, 1: group_input.outputs["Amount"]}, attrs={"operation": "DIVIDE"}
    )
    ...
    divide_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: multiply_4, 1: group_input.outputs["Amount"]}, attrs={"operation": "DIVIDE"}
    )
    ...
    set_position_1 = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": duplicate_elements_1.outputs["Geometry"], "Offset": combine_xyz_1}
    )

    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [quadrilateral, set_position, set_position_1]}
    )
...
def nodegroup_handle(nw: NodeWrangler):
    ...
    transform = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_1, "Translation": combine_xyz}
    )
    ...
    multiply_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["length"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    transform_1 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": store_named_attribute_2, "Translation": combine_xyz_2}
    )
...
def nodegroup_oven_geometry(
    nw: NodeWrangler, preprocess: bool = False, use_gas: bool = False, is_placeholder: bool = False
):
    # Code generated using version 2.6.5 of the node_transpiler
    ...
    multiply = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Width"], 1: 0.0500}, attrs={"operation": "MULTIPLY"}
    )

    multiply_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Width"], 1: 0.8000}, attrs={"operation": "MULTIPLY"}
    )

    multiply_2 = nw.new_node(Nodes.Math, input_kwargs={0: multiply}, attrs={"operation": "MULTIPLY"})

    handle = nw.new_node(
        nodegroup_handle().name, input_kwargs={"width": multiply, "length": multiply_1, "thickness": multiply_2}
    )
    ...
    multiply_5 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: 0.9200}, attrs={"operation": "MULTIPLY"}
    )
    ...
    set_material_8 = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": transform_1, "Material": group_input.outputs["WhiteMetal"]}
    )
    ...
    multiply_7 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: 0.0500}, attrs={"operation": "MULTIPLY"}
    )
    ...
    set_material_9 = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": text, "Material": group_input.outputs["WhiteMetal"]}
    )

    set_material_8 = complete_bevel(nw, set_material_8, preprocess)

    join_geometry_3 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [set_material_3, set_material_8, set_material_9]}
    )
    ...
    multiply_8 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["DoorThickness"], 1: 2.1000}, attrs={"operation": "MULTIPLY"}
    )

    subtract = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Depth"], 1: multiply_8}, attrs={"operation": "SUBTRACT"}
    )
    ...
    subtract_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Width"], 1: multiply_9}, attrs={"operation": "SUBTRACT"}
    )
    ...
    multiply_12 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["DoorThickness"], 1: 2.0000}, attrs={"operation": "MULTIPLY"}
    )

    subtract_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: multiply_12}, attrs={"operation": "SUBTRACT"}
    )
    ...
    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": duplicate_elements.outputs["Geometry"], "Offset": combine_xyz_5}
    )

    set_material = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": set_position, "Material": group_input.outputs["Surface"]}
    )
    ...
    set_material_5 = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": cube_1, "Material": group_input.outputs["Back"]}
    )
    ...
    combine_xyz_15 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": group_input.outputs["PanelThickness"], "Z": add_6}
    )
    ...
    add_7 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: group_input.outputs["DoorThickness"]}
    )
    ...
    scale = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: add_8.outputs["Vector"], "Scale": 0.5000}, attrs={"operation": "SCALE"}
    )

    separate_xyz = nw.new_node(Nodes.SeparateXYZ, input_kwargs={"Vector": scale.outputs["Vector"]})

    combine_xyz_16 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": reroute_13, "Y": multiply_14, "Z": separate_xyz.outputs["Z"]}
    )

    multiply_15 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["PanelHeight"], 1: 0.2000}, attrs={"operation": "MULTIPLY"}
    )

    text_1 = nw.new_node(
        nodegroup_text().name, input_kwargs={"Translation": combine_xyz_16, "String": "12:01", "Size": multiply_15}
    )
    ...
    multiply_16 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["PanelHeight"], 1: 0.0500}, attrs={"operation": "MULTIPLY"}
    )

    multiply_add_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: reroute_15, 1: 1.0000, 2: multiply_16}, attrs={"operation": "MULTIPLY_ADD"}
    )
    ...
    multiply_17 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["BottonRadius"], 1: 0.2500}, attrs={"operation": "MULTIPLY"}
    )

    text_2 = nw.new_node(
        nodegroup_text().name, input_kwargs={"Translation": combine_xyz_17, "String": "Off", "Size": multiply_17}
    )

    multiply_add_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: reroute_15, 1: 0.7000, 2: multiply_16}, attrs={"operation": "MULTIPLY_ADD"}
    )
    ...
    text_3 = nw.new_node(
        nodegroup_text().name, input_kwargs={"Translation": combine_xyz_18, "String": "High", "Size": multiply_17}
    )
    ...
    multiply_add_3 = nw.new_node(
        Nodes.Math, input_kwargs={0: reroute_15, 1: -0.7000, 2: multiply_18}, attrs={"operation": "MULTIPLY_ADD"}
    )

    combine_xyz_19 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": reroute_13, "Y": multiply_add_3, "Z": add_11})

    text_4 = nw.new_node(
        nodegroup_text().name, input_kwargs={"Translation": combine_xyz_19, "String": "Low", "Size": multiply_17}
    )
    ...
    multiply_19 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["BottonThickness"], 1: 0.1000}, attrs={"operation": "MULTIPLY"}
    )
    ...
    join_geometry_6 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [transform, text_2, text_3, text_4, text_5]}
    )
    ...
    divide_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Width"], 1: add_15}, attrs={"operation": "DIVIDE"}
    )
    ...
    set_position_1 = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": duplicate_elements_1.outputs["Geometry"], "Offset": combine_xyz_11}
    )
    ...
    set_material_6 = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": delete_geometry, "Material": group_input.outputs["WhiteMetal"]}
    )
    ...
    set_material_1 = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": hollowcube, "Material": group_input.outputs["Surface"]}
    )
    ...
    switch_2 = nw.new_node(
        Nodes.Switch,
        input_kwargs={"Switch": group_input.outputs["is_placeholder"], "False": join_geometry, "True": join_geometry_3},
    )
