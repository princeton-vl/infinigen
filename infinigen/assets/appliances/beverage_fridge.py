...
class BeverageFridgeFactory(AssetFactory):
    ...
    def create_asset(self, **params):
        ...
        obj = butil.spawn_cube()
        butil.modify_mesh(
            obj, "NODES", node_group=nodegroup_beverage_fridge_geometry(), ng_inputs=self.params, apply=True
        )
...
def nodegroup_hollow_cube(nw: NodeWrangler):
    ...
    cube_2 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz_4, "Vertices X": 2, "Vertices Y": 2, "Vertices Z": 2}
    )
    ...
    cube_1 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz_2, "Vertices X": 2, "Vertices Y": 2, "Vertices Z": 2}
    )
    ...
    cube = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz, "Vertices X": 2, "Vertices Y": 2, "Vertices Z": 2}
    )
    ...
    cube_3 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz_6, "Vertices X": 2, "Vertices Y": 2, "Vertices Z": 2}
    )
    ...
    cube_4 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz_9, "Vertices X": 2, "Vertices Y": 2, "Vertices Z": 2}
    )
    ...
    cube_5 = nw.new_node(
        Nodes.MeshCube, input_kwargs={"Size": combine_xyz_10, "Vertices X": 2, "Vertices Y": 2, "Vertices Z": 2}
    )
...
def nodegroup_beverage_fridge_geometry(nw: NodeWrangler, preprocess: bool = False):
    ...
    multiply_4 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: 0.9000}, attrs={"operation": "MULTIPLY"}
    )
    ...
    set_material_8 = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": transform_1, "Material": group_input.outputs["Handle"]}
    )
    ...
    set_material_9 = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": text, "Material": group_input.outputs["Handle"]}
    )

    rotate_instances_2 = complete_bevel(nw, rotate_instances_2, preprocess)

    join_geometry_3 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [set_material_3, rotate_instances_2, set_material_9]}
    )
    ...
    combine_xyz_4 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": group_input.outputs["Depth"], "Y": group_input.outputs["Width"]}
    )
    ...
    door = nw.new_node(
        Nodes.Reroute, input_kwargs={"Input": nw.new_node(Nodes.RealizeInstances, [rotate_instances])}, label="door"
    )
    ...
    set_material = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": set_position, "Material": group_input.outputs["Handle"]}
    )

    racks = nw.new_node(
        Nodes.Reroute, input_kwargs={"Input": nw.new_node(Nodes.RealizeInstances, [set_material])}, label="racks"
    )
