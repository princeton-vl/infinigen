...
class SinkFactory(AssetFactory):
    def __init__(self, factory_seed, coarse=False, dimensions=[1.0, 1.0, 1.0], upper_height=None):
    ...
    def _extract_geo_results(self):
        ...
        with butil.TemporaryObject(butil.spawn_vert()) as temp:
            obj = extract_nodegroup_geo(temp, nodegroup_sink_geometry(), "Geometry", ng_params=params)
            cutter = extract_nodegroup_geo(temp, nodegroup_sink_geometry(), "Cutter", ng_params=params)
...
def nodegroup_handle(nw: NodeWrangler):
    ...
    set_curve_radius = nw.new_node(Nodes.SetCurveRadius, input_kwargs={"Curve": bezier_segment, "Radius": multiply})
    ...
    map_range = nw.new_node(
        Nodes.MapRange, input_kwargs={"Value": separate_xyz.outputs["X"], 1: 0.2000, 3: 1.0000, 4: 2.5000}
    )
    ...
    combine_xyz = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": separate_xyz.outputs["X"], "Y": multiply_1, "Z": separate_xyz.outputs["Z"]}
    )

    set_position = nw.new_node(Nodes.SetPosition, input_kwargs={"Geometry": curve_to_mesh, "Position": combine_xyz})
...
def nodegroup_water_tap(nw: NodeWrangler):
    ...
    group_input = nw.new_node(Nodes.GroupInput, expose_input=[("NodeSocketMaterial", "Tap", None)])
    ...
    quadrilateral = nw.new_node(
        "GeometryNodeCurvePrimitiveQuadrilateral", input_kwargs={"Width": 0.2000, "Height": 0.7000}
    )
    ...
    switch = nw.new_node(
        Nodes.Switch, input_kwargs={1: group_input.outputs["Switch"], 14: transform_geometry_1, 15: curve_to_mesh_2}
    )

    curve_to_mesh_1 = nw.new_node(
        Nodes.CurveToMesh, input_kwargs={"Curve": switch.outputs[6], "Profile Curve": curve_circle_1.outputs["Curve"]}
    )
    ...
    greater_than = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["Z"], 1: -0.0100}, attrs={"operation": "GREATER_THAN"}
    )
    ...
    separate_geometry = nw.new_node(
        Nodes.SeparateGeometry, input_kwargs={"Geometry": curve_to_mesh_1, "Selection": switch_1.outputs["Output"]}
    )

    combine_xyz = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": 1.0000, "Y": 1.0000, "Z": group_input.outputs["tap_head"]}
    )
    ...
    combine_xyz_2 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": 1.0000, "Y": 1.0000, "Z": group_input.outputs["tap_height"]}
    )

    transform_geometry_5 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": join_geometry, "Rotation": combine_xyz_1, "Scale": combine_xyz_2}
    )
    ...
    join_geometry_2 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [transform_geometry_4, transform_geometry_3]}
    )
    ...
    join_geometry_3 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [switch_5.outputs[6], transform_geometry_8]}
    )
    ...
    join_geometry_4 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [switch_4.outputs[6], switch_7.outputs[6]]}
    )
    ...
    transform_geometry_11 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": join_geometry_5, "Scale": combine_xyz_4}
    )

    switch_3 = nw.new_node(
        Nodes.Switch, input_kwargs={1: group_input.outputs["hand_type"], 14: join_geometry_2, 15: transform_geometry_11}
    )
    ...
    map_range = nw.new_node(
        Nodes.MapRange, input_kwargs={"Value": separate_xyz_1.outputs["X"], 1: 0.2000, 3: 1.0000, 4: 2.5000}
    )
    ...
    cylinder_2 = nw.new_node(
        "GeometryNodeMeshCylinder", input_kwargs={"Vertices": 100, "Radius": 0.0100, "Depth": 0.7000}
    )
    ...
    cylinder_3 = nw.new_node(
        "GeometryNodeMeshCylinder", input_kwargs={"Vertices": 318, "Radius": 0.0200, "Depth": 0.0300}
    )

    transform_geometry_14 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": cylinder_3.outputs["Mesh"], "Translation": (0.5950, 0.0000, 0.3800)}
    )

    join_geometry_7 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [transform_geometry_13, transform_geometry_14]}
    )

    transform_geometry_15 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": join_geometry_7, "Scale": (0.9000, 1.0000, 1.0000)}
    )
    ...
    transform_geometry_16 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": join_geometry_8, "Rotation": (0.0000, 0.0000, 3.1416)}
    )
    ...
    join_geometry_6 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [switch_6.outputs[6], extrude_mesh_1.outputs["Mesh"]]}
    )

    set_material = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": join_geometry_6, "Material": group_input.outputs["Tap"]}
    )
...
def nodegroup_sink_geometry(nw: NodeWrangler):
    ...
    quadrilateral = nw.new_node(
        "GeometryNodeCurvePrimitiveQuadrilateral", input_kwargs={"Width": reroute_3, "Height": reroute_2}
    )
    ...
    combine_xyz_1 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": group_input.outputs["Curvature"], "Y": group_input.outputs["Curvature"]}
    )
    ...
    join_geometry_4 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [transform_1, curve_circle.outputs["Curve"]]}
    )
    ...
    transform_2 = nw.new_node(Nodes.Transform, input_kwargs={"Geometry": fill_curve_1, "Translation": combine_xyz_2})

    extrude_mesh_2 = nw.new_node(
        Nodes.ExtrudeMesh, input_kwargs={"Mesh": transform_2, "Offset Scale": -0.0100, "Individual": False}
    )

    transform_5 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": curve_circle.outputs["Curve"], "Scale": (0.7000, 0.7000, 1.0000)}
    )

    join_geometry_6 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [curve_circle.outputs["Curve"], transform_5]}
    )
    ...
    transform_6 = nw.new_node(Nodes.Transform, input_kwargs={"Geometry": fill_curve_4, "Translation": combine_xyz_4})

    extrude_mesh_4 = nw.new_node(
        Nodes.ExtrudeMesh,
        input_kwargs={"Mesh": transform_6, "Offset Scale": group_input.outputs["Lower Height"], "Individual": False},
    )
    ...
    transform_7 = nw.new_node(Nodes.Transform, input_kwargs={"Geometry": curve_to_mesh, "Translation": combine_xyz_2})
    ...
    transform = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": sink_interior_border, "Scale": (0.9900, 0.9900, 1.0000)}
    )
    ...
    extrude_mesh_1 = nw.new_node(
        Nodes.ExtrudeMesh, input_kwargs={"Mesh": fill_curve, "Offset Scale": group_input.outputs["Lower Height"]}
    )
    ...
    combine_xyz = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": multiply_1, "Y": multiply_2, "Z": separate_xyz_1.outputs["Z"]}
    )

    set_position = nw.new_node(
        Nodes.SetPosition,
        input_kwargs={"Geometry": extrude_mesh_1.outputs["Mesh"], "Selection": less_than, "Position": combine_xyz},
    )

    add_2 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["Width"], 1: group_input.outputs["Margin"]})

    add_3 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["Depth"], 1: group_input.outputs["Margin"]})

    add_4 = nw.new_node(Nodes.Math, input_kwargs={0: add_3, 1: group_input.outputs["WaterTapMargin"]})

    quadrilateral_1 = nw.new_node(
        "GeometryNodeCurvePrimitiveQuadrilateral", input_kwargs={"Width": add_4, "Height": add_2}
    )

    multiply_3 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["WaterTapMargin"], 1: -0.5000}, attrs={"operation": "MULTIPLY"}
    )

    combine_xyz_7 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": multiply_3})

    transform_8 = nw.new_node(Nodes.Transform, input_kwargs={"Geometry": quadrilateral_1, "Translation": combine_xyz_7})
    ...
    multiply_4 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Lower Height"], 1: -1.0000}, attrs={"operation": "MULTIPLY"}
    )
    ...
    transform_3 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": extrude_mesh_3.outputs["Mesh"], "Translation": combine_xyz_3}
    )
    ...
    add_6 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Depth"], 1: group_input.outputs["WaterTapMargin"]}
    )

    multiply_5 = nw.new_node(Nodes.Math, input_kwargs={0: add_6, 1: -0.5000}, attrs={"operation": "MULTIPLY"})

    combine_xyz_8 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": multiply_5, "Z": group_input.outputs["Upper Height"]}
    )
    ...
    set_material = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": join_geometry_1, "Material": group_input.outputs["Sink"]}
    )

    add_7 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["WaterTapMargin"], 1: group_input.outputs["Margin"]}
    )
    ...
    fill_interior = nw.new_node(
        Nodes.FillCurve, input_kwargs={"Curve": scaled_sink_interior_border}, attrs={"mode": "NGONS"}
    )

    extrude_amt = nw.scalar_add(group_input.outputs["Lower Height"], group_input.outputs["Upper Height"], 0.05)
    extrude = nw.new_node(Nodes.ExtrudeMesh, input_kwargs={"Mesh": fill_interior, "Offset Scale": extrude_amt})
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Geometry": set_position_1, "Cutter": setpos_move_cutter}
    )
...
def geometry_node_to_bbox(nw: NodeWrangler):
    ...
    transform_geometry = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": bounding_box, "Scale": (0.100, 0.100, 0.1000)}
    )
