...
def nodegroup_quadruped_body(nw: NodeWrangler):
    ...
    bottom_flank_0 = nw.new_node(
        ...
        input_kwargs={
            ...
            "StartRad, EndRad, Fullness": group_input_1.outputs["BottomFlank StartRad, EndRad, Fullness"],
    ...
    top_flank = nw.new_node(
        ...
        input_kwargs={
            ...
            "StartRad, EndRad, Fullness": group_input_1.outputs["TopFlank StartRad, EndRad, Fullness"],
            "ProfileHeight, StartTilt, EndTilt": group_input_1.outputs["TopFlank ProfileHeight, StartTilt, EndTilt"],
        },
        label="Top  Flank",
    )
    ...
    back_flank = nw.new_node(
        ...
        input_kwargs={
            ...
            "StartRad, EndRad, Fullness": group_input_1.outputs["BackFlank StartRad, EndRad, Fullness"],
            "ProfileHeight, StartTilt, EndTilt": group_input_1.outputs["BackFlank ProfileHeight, StartTilt, EndTilt"],
        },
        label="Back Flank",
    )
    ...
    belly = nw.new_node(
        ...
        input_kwargs={
            ...
            "StartRad, EndRad, Fullness": group_input_1.outputs["Belly StartRad, EndRad, Fullness"],
            "ProfileHeight, StartTilt, EndTilt": group_input_1.outputs["Belly ProfileHeight, StartTilt, EndTilt"],
        },
        label="Belly",
    )

    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [bottom_flank_0, top_flank, bottom_flank_1, back_flank, belly]}
    )
    ...
    spine = nw.new_node(
        ...
        input_kwargs={
            ...
            "StartRad, EndRad, Fullness": group_input_1.outputs["Spine StartRad, EndRad, Fullness"],
    ...
    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [union, symmetric_clone.outputs["Both"], spine]}
    )

    reroute = nw.new_node(Nodes.Reroute, input_kwargs={"Input": quadratic_bezier})

    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Geometry": join_geometry, "Skeleton Curve": reroute, "Base Mesh": union}
    )
