...
def nodegroup_chameleon_toe(nw: NodeWrangler):
    ...
    capture_attribute = nw.new_node(
        Nodes.CaptureAttribute, input_kwargs={"Geometry": set_curve_radius, 2: spline_parameter_1.outputs["Factor"]}
    )
...
def nodegroup_floor_ceil(nw: NodeWrangler):
    ...
    float_to_integer = nw.new_node(
        Nodes.FloatToInt, input_kwargs={"Float": group_input.outputs["Value"]}, attrs={"rounding_mode": "FLOOR"}
    )

    float_to_integer_1 = nw.new_node(
        Nodes.FloatToInt, input_kwargs={"Float": group_input.outputs["Value"]}, attrs={"rounding_mode": "CEILING"}
    )

    subtract = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Value"], 1: float_to_integer}, attrs={"operation": "SUBTRACT"}
    )
...
def nodegroup_clamp_or_wrap(nw: NodeWrangler):
    ...
    clamp = nw.new_node(
        Nodes.Clamp, input_kwargs={"Value": group_input.outputs["Value"], "Max": group_input.outputs["Max"]}
    )
    ...
    switch = nw.new_node(
        Nodes.Switch, input_kwargs={0: group_input.outputs["Use Wrap"], 4: clamp, 5: wrap}, attrs={"input_type": "INT"}
    )

    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Output": switch.outputs[1]}, attrs={"is_active_output": True}
    )
...
def nodegroup_chameleon_claw_shape(nw: NodeWrangler):
    ...
    simpletube = nw.new_node(
        nodegroup_simple_tube().name, input_kwargs={"Curve": quadratic_bezier, "RadStartEnd": (0.2000, 0.2000, 1.0000)}
    )
    ...
    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [curvesculpt.outputs["Geometry"], transform_1, transform_2]}
    )
...
def nodegroup_chameleon_foot_shape(nw: NodeWrangler):
    ...
    chameleon_claw_shape = nw.new_node(
        nodegroup_chameleon_claw_shape().name, input_kwargs={"Rotation": (0.0000, 0.0000, 0.0000)}
    )
...
def nodegroup_polar_to_cart(nw: NodeWrangler):
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Vector": offset_polar.outputs["Vector"]}, attrs={"is_active_output": True}
    )
...
def nodegroup_switch4(nw: NodeWrangler):
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Output": switch.outputs[3]}, attrs={"is_active_output": True}
    )
...
def nodegroup_scale_bump(nw: NodeWrangler):
    ...
    scale_2 = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: normal, "Scale": scale_1.outputs["Vector"]}, attrs={"operation": "SCALE"}
    )
    ...
    scale_4 = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: normal, "Scale": scale_3.outputs["Vector"]}, attrs={"operation": "SCALE"}
    )
...
def nodegroup_chameleon_leg_raw_shape(nw: NodeWrangler):
    ...
    multiply = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["thigh_length"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    scale = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: combine_xyz_7, "Scale": 0.0174}, attrs={"operation": "SCALE"}
    )
    ...
    multiply_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["calf_length"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    combine_xyz = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"Y": group_input.outputs["thigh_calf_rotation"], "Z": add_1}
    )

    scale_1 = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: combine_xyz, "Scale": 0.0174}, attrs={"operation": "SCALE"}
    )
    ...
    scale_2 = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: combine_xyz_1, "Scale": 0.0174}, attrs={"operation": "SCALE"}
    )

    add_2 = nw.new_node(Nodes.Math, input_kwargs={0: group_input.outputs["toe_toe_rotation"], 1: 180.0000})

    combine_xyz_6 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"Y": group_input.outputs["thigh_calf_rotation"], "Z": add_2}
    )

    scale_3 = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: combine_xyz_6, "Scale": 0.0174}, attrs={"operation": "SCALE"}
    )
    ...
    sample_curve = nw.new_node(
        Nodes.SampleCurve, input_kwargs={"Curve": transform_geometry_2, "Factor": 0.8500}, attrs={"mode": "FACTOR"}
    )

    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": chameleon_foot_shape, "Offset": sample_curve.outputs["Position"]}
    )

    round_bump_2 = nw.new_node(
        nodegroup_round_bump().name, input_kwargs={"Geometry": set_position, "Distance": 0.0050, "Offset Scale": 0.0020}
    )
    ...
    sample_curve_1 = nw.new_node(
        Nodes.SampleCurve, input_kwargs={"Curve": transform_geometry_3, "Factor": 1.0000}, attrs={"mode": "FACTOR"}
    )
    ...
    set_position_1 = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": join_geometry, "Offset": scale_4.outputs["Vector"]}
    )

    subdivision_surface = nw.new_node(Nodes.SubdivisionSurface, input_kwargs={"Mesh": set_position_1})

    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Mesh": subdivision_surface}, attrs={"is_active_output": True}
    )
...
def nodegroup_chameleon_tail_shape(nw: NodeWrangler):
    ...
    subdivision_surface = nw.new_node(
        Nodes.SubdivisionSurface, input_kwargs={"Mesh": curvesculpt.outputs["Geometry"], "Level": 2}
    )
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Mesh": transform, "Curve": transform_1}, attrs={"is_active_output": True}
    )
...
def nodegroup_back_bump1(nw: NodeWrangler):
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Geometry": curvesculpt.outputs["Geometry"]}, attrs={"is_active_output": True}
    )
...
def nodegroup_curve_parameter_curve(nw: NodeWrangler):
    ...
    dot_product = nw.new_node(
        Nodes.VectorMath, input_kwargs={0: normal, 1: normal_1}, attrs={"operation": "DOT_PRODUCT"}
    )
...
def nodegroup_curve_sculpt(nw: NodeWrangler):
    ...
    symmetric_clone = nw.new_node(
        nodegroup_symmetric_clone().name, input_kwargs={"Geometry": group_input_1.outputs["Curve"]}
    )
    ...
    curve_to_mesh_1 = nw.new_node(
        Nodes.CurveToMesh, input_kwargs={"Curve": group_input_1.outputs["StrokeRadFacModifier"]}
    )
    ...
    add_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["Base Factor"], 1: separate_xyz.outputs["Y"]}
    )

    multiply = nw.new_node(
        Nodes.Math, input_kwargs={0: switch_2.outputs["Output"], 1: add_1}, attrs={"operation": "MULTIPLY"}
    )

    scale = nw.new_node(Nodes.VectorMath, input_kwargs={0: normal, "Scale": multiply}, attrs={"operation": "SCALE"})

    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": group_input_1.outputs["Target"], "Offset": scale.outputs["Vector"]}
    )
    ...
    switch_3 = nw.new_node(
        Nodes.Switch, input_kwargs={1: group_input_1.outputs["Attr"], 14: set_position, 15: store_named_attribute}
    )
...
def nodegroup_chameleon_eye(nw: NodeWrangler):
    ...
    transform = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": simpletube.outputs["Mesh"], "Scale": (4.0000, 4.5000, 4.5000)}
    )
    ...
    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": scale_bump, "Offset": scale.outputs["Vector"]}
    )
    ...
    transform_1 = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": set_material, "Scale": (0.0500, 0.0600, 0.0600)}
    )
...
def shader_chameleon(nw: NodeWrangler):
    ...
    noise_texture_1 = nw.new_node(
        Nodes.NoiseTexture,
        input_kwargs={"Vector": texture_coordinate.outputs["Generated"], "Scale": 10.0000, "Distortion": 2.0000},
    )
    ...
    principled_bsdf_1 = nw.new_node(
        Nodes.PrincipledBSDF, input_kwargs={"Base Color": combine_color, "Specular": 0.3000, "Roughness": 0.6000}
    )

    material_output_1 = nw.new_node(
        Nodes.MaterialOutput, input_kwargs={"Surface": principled_bsdf_1}, attrs={"is_active_output": True}
    )
...
def nodegroup_chameleon_tail(nw: NodeWrangler):
    ...
    sample_curve = nw.new_node(
        Nodes.SampleCurve, input_kwargs={"Curve": chameleon_tail_shape.outputs["Curve"]}, attrs={"mode": "FACTOR"}
    )
...
def nodegroup_chameleon_body_shape(nw: NodeWrangler):
    ...
    transform_geometry = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": simpletube.outputs["Mesh"], "Scale": group_input.outputs["Scale"]}
    )
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Mesh": join_geometry}, attrs={"is_active_output": True}
    )
...
def nodegroup_chameleon_head_shape(nw: NodeWrangler):
    ...
    transform = nw.new_node(
        Nodes.Transform, input_kwargs={"Geometry": simpletube.outputs["Mesh"], "Scale": group_input_2.outputs["Scale"]}
    )
    ...
    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [quadratic_bezier_8, quadratic_bezier_12]}
    )
    ...
    join_geometry_2 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [quadratic_bezier_14, quadratic_bezier_13]}
    )
    ...
    join_geometry_3 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [quadratic_bezier_23, quadratic_bezier_24]}
    )
    ...
    merge_by_distance_1 = nw.new_node(
        Nodes.MergeByDistance, input_kwargs={"Geometry": curvesculpt_16.outputs["Geometry"], "Distance": 0.0000}
    )
...
def nodegroup_round_bump(nw: NodeWrangler):
    ...
    merge_by_distance = nw.new_node(
        Nodes.MergeByDistance, input_kwargs={"Geometry": subdivide_mesh, "Distance": group_input.outputs["Distance"]}
    )
    ...
    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [set_shade_smooth, group_input.outputs["Geometry"]]}
    )
...
def shader_chameleon_eye(nw: NodeWrangler):
    ...
    noise_texture = nw.new_node(
        Nodes.NoiseTexture, input_kwargs={"Vector": mapping, "W": 1.0000}, attrs={"noise_dimensions": "4D"}
    )
...
def nodegroup_chameleon(nw: NodeWrangler):
    ...
    round_bump = nw.new_node(
        nodegroup_round_bump().name, input_kwargs={"Geometry": transform, "Distance": 0.0080, "Offset Scale": 0.0030}
    )

    chameleon_body_shape = nw.new_node(
        nodegroup_chameleon_body_shape().name, input_kwargs={"length": group_input.outputs["body_length"]}
    )
    ...
    join_geometry_2 = nw.new_node(
        Nodes.JoinGeometry,
        input_kwargs={
            "Geometry": [chameleon_leg_shape, chameleon_leg_shape_1, chameleon_leg_shape_2, chameleon_leg_shape_3]
        },
    )

    join_geometry_1 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [round_bump, round_bump_1, round_bump_2, join_geometry_2]}
    )
    ...
    chameleon_eye = nw.new_node(
        nodegroup_chameleon_eye().name, input_kwargs={"pupil_radius": group_input.outputs["pupil_radius"]}
    )
