...
class BoxFactory(AssetFactory):
    options = {"timestep": "0.001", "integrator": "RK4"}
    ...
    def sample_joint_parameters(
        cls,
        F1_bottom_lid_axis_stiffness_min: float = 0.0,
        F1_bottom_lid_axis_stiffness_max: float = 0.0,
        F1_bottom_lid_axis_damping_min: float = 0.5,
        F1_bottom_lid_axis_damping_max: float = 2.0,
        F1_top_flap_top_left_flap_axis_stiffness_min: float = 0.0,
        F1_top_flap_top_left_flap_axis_stiffness_max: float = 0.0,
        F1_top_flap_top_left_flap_axis_damping_min: float = 0.5,
        F1_top_flap_top_left_flap_axis_damping_max: float = 2.0,
        F4_both_lids_stiffness_min: float = 0.0,
        F4_both_lids_stiffness_max: float = 0.0,
        F4_both_lids_damping_min: float = 0.5,
        F4_both_lids_damping_max: float = 2.0,
        F1_top_right_lid_axis_stiffness_min: float = 0.0,
        F1_top_right_lid_axis_stiffness_max: float = 0.0,
        F1_top_right_lid_axis_damping_min: float = 0.5,
        F1_top_right_lid_axis_damping_max: float = 2.0,
        F12_folding_edge_stiffness_min: float = 0.0,
        F12_folding_edge_stiffness_max: float = 0.0,
        F12_folding_edge_damping_min: float = 0.5,
        F12_folding_edge_damping_max: float = 2.0,
        F3_top_lid_axis_stiffness_min: float = 0.0,
        F3_top_lid_axis_stiffness_max: float = 0.0,
        F3_top_lid_axis_damping_min: float = 0.5,
        F3_top_lid_axis_damping_max: float = 2.0,
        F1234_folding_edge_stiffness_min: float = 0.0,
        F1234_folding_edge_stiffness_max: float = 0.0,
        F1234_folding_edge_damping_min: float = 0.5,
        F1234_folding_edge_damping_max: float = 2.0,
        F1_top_lid_top_flap_axis_stiffness_min: float = 0.0,
        F1_top_lid_top_flap_axis_stiffness_max: float = 0.0,
        F1_top_lid_top_flap_axis_damping_min: float = 0.5,
        F1_top_lid_top_flap_axis_damping_max: float = 2.0,
        F1_top_left_lid_axis_stiffness_min: float = 0.0,
        F1_top_left_lid_axis_stiffness_max: float = 0.0,
        F1_top_left_lid_axis_damping_min: float = 0.5,
        F1_top_left_lid_axis_damping_max: float = 2.0,
        F2_bottom_lid_axis_stiffness_min: float = 0.0,
        F2_bottom_lid_axis_stiffness_max: float = 0.0,
        F2_bottom_lid_axis_damping_min: float = 0.5,
        F2_bottom_lid_axis_damping_max: float = 2.0,
        F1_top_lid_axis_stiffness_min: float = 0.0,
        F1_top_lid_axis_stiffness_max: float = 0.0,
        F1_top_lid_axis_damping_min: float = 0.5,
        F1_top_lid_axis_damping_max: float = 2.0,
        F4_top_lid_stiffness_min: float = 0.0,
        F4_top_lid_stiffness_max: float = 0.0,
        F4_top_lid_damping_min: float = 0.5,
        F4_top_lid_damping_max: float = 2.0,
        F3_bottom_lid_axis_stiffness_min: float = 0.0,
        F3_bottom_lid_axis_stiffness_max: float = 0.0,
        F3_bottom_lid_axis_damping_min: float = 0.5,
        F3_bottom_lid_axis_damping_max: float = 2.0,
        F1_top_flap_top_right_flap_axis_stiffness_min: float = 0.0,
        F1_top_flap_top_right_flap_axis_stiffness_max: float = 0.0,
        F1_top_flap_top_right_flap_axis_damping_min: float = 0.5,
        F1_top_flap_top_right_flap_axis_damping_max: float = 2.0,
        F34_folding_edge_stiffness_min: float = 0.0,
        F34_folding_edge_stiffness_max: float = 0.0,
        F34_folding_edge_damping_min: float = 0.5,
        F34_folding_edge_damping_max: float = 2.0,
        F2_top_lid_axis_stiffness_min: float = 0.0,
        F2_top_lid_axis_stiffness_max: float = 0.0,
        F2_top_lid_axis_damping_min: float = 0.5,
        F2_top_lid_axis_damping_max: float = 2.0,
    ):
        return {
            "F1_bottom_lid_axis": {
                "stiffness": uniform(
