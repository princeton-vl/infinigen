...
def nodegroup_window_geometry(nw: NodeWrangler):
    ...
    subtract = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["Width"], 1: multiply}, attrs={"operation": "SUBTRACT"}
    )

    divide = nw.new_node(
        Nodes.Math, input_kwargs={0: subtract, 1: group_input_1.outputs["PanelVAmount"]}, attrs={"operation": "DIVIDE"}
    )

    subtract_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: divide, 1: group_input_1.outputs["SubFrameWidth"]}, attrs={"operation": "SUBTRACT"}
    )
    ...
    subtract_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["Height"], 1: multiply_1}, attrs={"operation": "SUBTRACT"}
    )
    ...
    switch = nw.new_node(
        Nodes.Switch, input_kwargs={1: group_input_1.outputs["Shutter"], 14: windowpanel_1, 15: windowshutter}
    )

    multiply_2 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["Width"], 1: -0.5000}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_4 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["Height"], 1: -0.5000}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_9 = nw.new_node(
        Nodes.Math, input_kwargs={0: power, 1: group_input_1.outputs["OEOffset"]}, attrs={"operation": "MULTIPLY"}
    )

    combine_xyz_1 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": multiply_7, "Y": multiply_8, "Z": multiply_9})

    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": duplicate_elements.outputs["Geometry"], "Offset": combine_xyz_1}
    )

    power_1 = nw.new_node(Nodes.Math, input_kwargs={0: -1.0000, 1: floor}, attrs={"operation": "POWER"})

    multiply_10 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["OpenVAngle"], 1: power_1}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_13 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["OpenHAngle"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_15 = nw.new_node(
        Nodes.Math, input_kwargs={0: power_2, 1: group_input_1.outputs["OpenOffset"]}, attrs={"operation": "MULTIPLY"}
    )

    combine_xyz_4 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"X": multiply_15})

    set_position_1 = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": rotate_instances_1, "Offset": combine_xyz_4}
    )

    join_geometry = nw.new_node(Nodes.JoinGeometry, input_kwargs={"Geometry": [windowpanel, set_position_1]})

    multiply_16 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["Width"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_19 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input_1.outputs["FrameThickness"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    switch_1 = nw.new_node(
        Nodes.Switch, input_kwargs={1: group_input_1.outputs["Curtain"], 14: join_geometry, 15: join_geometry_1}
    )
...
def nodegroup_line_seq(nw: NodeWrangler):
    ...
    divide = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: add_1}, attrs={"operation": "DIVIDE"}
    )
    ...
    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": duplicate_elements.outputs["Geometry"], "Offset": combine_xyz_2}
    )

    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Curve": set_position}, attrs={"is_active_output": True}
    )
...
def nodegroup_curtain(nw: NodeWrangler):
    ...
    join_geometry_2 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [set_position_2, curve_to_mesh_1, set_position_3]}
    )

    multiply_3 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["Height"], 1: -0.4700}, attrs={"operation": "MULTIPLY"}
    )
    ...
    capture_attribute = nw.new_node(
        Nodes.CaptureAttribute, input_kwargs={"Geometry": join_geometry_1, 2: spline_parameter_1.outputs["Factor"]}
    )

    spline_parameter = nw.new_node(Nodes.SplineParameter)

    multiply_4 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["IntervalNumber"], 1: 6.2800}, attrs={"operation": "MULTIPLY"}
    )

    divide = nw.new_node(
        Nodes.Math, input_kwargs={0: multiply_4, 1: group_input.outputs["Width"]}, attrs={"operation": "DIVIDE"}
    )

    multiply_5 = nw.new_node(
        Nodes.Math, input_kwargs={0: spline_parameter.outputs["Length"], 1: divide}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_6 = nw.new_node(
        Nodes.Math, input_kwargs={0: sine, 1: group_input.outputs["Depth"]}, attrs={"operation": "MULTIPLY"}
    )

    combine_xyz_2 = nw.new_node(Nodes.CombineXYZ, input_kwargs={"Z": multiply_6})

    set_position = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": capture_attribute.outputs["Geometry"], "Offset": combine_xyz_2}
    )

    reroute = nw.new_node(Nodes.Reroute, input_kwargs={"Input": group_input.outputs["Height"]})

    quadrilateral = nw.new_node(
        "GeometryNodeCurvePrimitiveQuadrilateral", input_kwargs={"Width": reroute, "Height": 0.0020}
    )
    ...
    divide_1 = nw.new_node(
        Nodes.Math, input_kwargs={0: separate_xyz.outputs["X"], 1: reroute}, attrs={"operation": "DIVIDE"}
    )
    ...
    combine_xyz_12 = nw.new_node(
        Nodes.CombineXYZ, input_kwargs={"X": capture_attribute_1.outputs[2], "Y": capture_attribute.outputs[2]}
    )
    ...
    curve_to_mesh_2 = nw.new_node(
        Nodes.CurveToMesh, input_kwargs={"Curve": curve_line, "Profile Curve": curve_circle_1.outputs["Curve"]}
    )
    ...
    set_position_4 = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": curve_to_mesh_2, "Offset": combine_xyz_10}
    )

    difference = nw.new_node(Nodes.MeshBoolean, input_kwargs={"Mesh 1": set_material, "Mesh 2": set_position_4})

    join_geometry = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [set_material_1, difference.outputs["Mesh"]]}
    )
...
def nodegroup_window_shutter(nw: NodeWrangler):
    ...
    multiply = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["FrameWidth"], 1: sqrt}, attrs={"operation": "MULTIPLY"}
    )
    ...
    curve_to_mesh = nw.new_node(
        Nodes.CurveToMesh, input_kwargs={"Curve": quadrilateral, "Profile Curve": quadrilateral_1}
    )
    ...
    geometry_to_instance = nw.new_node(
        "GeometryNodeGeometryToInstance", input_kwargs={"Geometry": cube.outputs["Mesh"]}
    )
    ...
    shutter_number = nw.new_node(
        Nodes.Math, input_kwargs={0: floor, 1: 1.0000}, label="ShutterNumber", attrs={"operation": "SUBTRACT"}
    )
    ...
    shutter_true_interval = nw.new_node(
        Nodes.Math, input_kwargs={0: subtract_1, 1: floor}, label="ShutterTrueInterval", attrs={"operation": "DIVIDE"}
    )
    ...
    rotate_instances = nw.new_node(
        Nodes.RotateInstances, input_kwargs={"Instances": set_position, "Rotation": combine_xyz_5}
    )

    multiply_3 = nw.new_node(
        Nodes.Math, input_kwargs={0: shutter_true_interval, 1: 2.0000}, attrs={"operation": "MULTIPLY"}
    )
    ...
    multiply_4 = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["ShutterWidth"]}, attrs={"operation": "MULTIPLY"}
    )
    ...
    rotate_instances_1 = nw.new_node(
        Nodes.RotateInstances, input_kwargs={"Instances": geometry_to_instance_1, "Rotation": combine_xyz_4}
    )
    ...
    set_position_1 = nw.new_node(
        Nodes.SetPosition, input_kwargs={"Geometry": cube_1.outputs["Mesh"], "Offset": sample_curve.outputs["Position"]}
    )

    join_geometry_2 = nw.new_node(
        Nodes.JoinGeometry, input_kwargs={"Geometry": [curve_to_mesh, rotate_instances, set_position_1]}
    )

    set_material = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": join_geometry_2, "Material": group_input.outputs["FrameMaterial"]}
    )
    ...
    group_output = nw.new_node(
        Nodes.GroupOutput, input_kwargs={"Geometry": realize_instances_1}, attrs={"is_active_output": True}
    )
...
def nodegroup_window_panel(nw: NodeWrangler):
    ...
    subtract = nw.new_node(
        Nodes.Math, input_kwargs={0: group_input.outputs["PanelThickness"], 1: 0.0010}, attrs={"operation": "SUBTRACT"}
    )

    quadrilateral_2 = nw.new_node(
        "GeometryNodeCurvePrimitiveQuadrilateral", input_kwargs={"Width": reroute, "Height": subtract}
    )
    ...
    quadrilateral_3 = nw.new_node(
        "GeometryNodeCurvePrimitiveQuadrilateral", input_kwargs={"Width": reroute, "Height": subtract_1}
    )

    curve_to_mesh_2 = nw.new_node(
        Nodes.CurveToMesh, input_kwargs={"Curve": transform, "Profile Curve": quadrilateral_3}
    )
    ...
    set_material = nw.new_node(
        Nodes.SetMaterial, input_kwargs={"Geometry": store_named_attribute, "Material": group_input.outputs["Material"]}
    )

    join_geometry = nw.new_node(Nodes.JoinGeometry, input_kwargs={"Geometry": [set_material, set_material_1]})

    switch = nw.new_node(
        Nodes.Switch, input_kwargs={1: group_input.outputs["WithGlass"], 14: set_material_1, 15: join_geometry}
    )

    set_shade_smooth = nw.new_node(
        Nodes.SetShadeSmooth, input_kwargs={"Geometry": switch.outputs[6], "Shade Smooth": False}
    )
...
def shader_glass_material(nw: NodeWrangler):
    ...
    principled_bsdf = nw.new_node(
        Nodes.PrincipledBSDF, input_kwargs={"Base Color": (0.0094, 0.0055, 0.8000, 1.0000), "Roughness": 0.0000}
    )
