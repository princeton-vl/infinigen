...
class CactusFactory(AssetFactory):
    ...
    def create_asset(self, face_size=0.01, realize=True, **params):
        ...
        if self.factory.noise_strength > 0:
            ...
            butil.modify_mesh(obj, "DISPLACE", True, strength=self.factory.noise_strength, mid_level=0, texture=texture)
    ...
    def shader_cactus(nw: NodeWrangler, base_hue):
        ...
        fresnel_color = hsv2rgba((base_hue - uniform(0.05, 0.1)) % 1, 0.9, uniform(0.3, 0.5))
        specular = 0.25
