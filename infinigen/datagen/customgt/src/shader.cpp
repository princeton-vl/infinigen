...
void ShaderBase::setUVec3(const std::string &name, unsigned int x, unsigned int y,
...
void ShaderBase::setUVec4(const std::string &name, unsigned int x, unsigned int y, unsigned int z,
